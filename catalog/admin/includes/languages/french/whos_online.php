<?php
/*
$Id: whos_online.php 1857 2012-06-20 01:21:38Z michael.oscmax@gmail.com $
...
define('TEXT_LAST_REFRESH', 'Dernière Mise à Jour'); //for version 2.9 by azer was missing
...
define('TABLE_HEADING_ENTRY_TIME', 'Arrivé ');
...
define('TEXT_HTTP_REFERER_NOT_FOUND', 'Non Trouvé');
...
define('TEXT_DUPLICATE_IP', 'Adresse IP Dupliquées');
define('TEXT_DUPLICATE_IPS', 'Adresses IPs Dupliquées');
define('TEXT_BOT', 'Robot');
define('TEXT_BOTS', 'Robots');
define('TEXT_ME', 'Moi!');
define('TEXT_ALL', 'Tous');
define('TEXT_REAL_CUSTOMER', 'Client Réels');
define('TEXT_REAL_CUSTOMERS', 'Clients Réels');
define('TEXT_ACTIVE_CUSTOMER', ' Actif.');
define('TEXT_ACTIVE_CUSTOMERS', ' Actif.');

define('TEXT_YOUR_IP_ADDRESS', 'Votre Adresse IP');
define('TEXT_SET_REFRESH_RATE', 'Délai de Raffraichissement');
define('TEXT_NONE_', 'Aucun');
define('TEXT_CUSTOMERS', 'Clients');
define('TEXT_SHOW_BOTS', 'Montrez Robots');
define('TEXT_SHOW_MAP', 'Montrez carte');
define('TEXT_COUNTRY', 'Pays');
define('TEXT_REGION', 'Région');
