...
?>
      ...
      <tr>
        <td><?php echo tep_draw_form('newsletter', FILENAME_NEWSLETTERS, (isset($_GET['page']) ? 'page=' . $_GET['page'] . '&amp;' : '') . 'action=' . $form_action); if ($form_action == 'update') echo tep_draw_hidden_field('newsletter_id', $nID); ?>
...
/*          <td class="main"><?php echo tep_draw_textarea_field('content', '100%', '20', $nInfo->content); ?></td> */ ?>
	    ...
	    // BOF: CKeditor
			    ...
			    echo tep_draw_textarea_field('content', '100', '20', $nInfo->content) . '</td>';
              } // EOF: CKeditor
              ?>
