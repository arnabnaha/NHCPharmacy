<?php
/*
$Id: index.php 1692 2012-02-26 01:26:50Z michael.oscmax@gmail.com $
...
define('DASHBOARD_PWA_OPC_ERROR', 'Error: Están habilitados <u><a href="' . tep_href_link(FILENAME_CONFIGURATION, 'gID=7575&amp;cID=3069', 'NONSSL') . '">Pedido en una página</a></u> y <u><a href="' . tep_href_link(FILENAME_CONFIGURATION, 'gID=5&amp;cID=1449', 'NONSSL') . '">Comprar sin cuenta</a></u>.  Por favor deshabilita uno de estos módulos.');
