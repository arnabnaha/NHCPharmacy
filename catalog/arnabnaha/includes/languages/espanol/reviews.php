<?php
/*
$Id: reviews.php 1692 2012-02-26 01:26:50Z michael.oscmax@gmail.com $
...
define('TABLE_HEADING_STATUS', 'Aprobado');
...
define('ENTRY_REVIEW_TEXT', '<small><font color="#ff0000"><b>NOTA:</b></font></small>&nbsp;¡El código HTML no se interpreta!&nbsp;');
define('ENTRY_RATING', 'Valoración:');

define('TEXT_INFO_DELETE_REVIEW_INTRO', '¿Seguro que quieres eliminar este comentario?');
...
define('TEXT_INFO_REVIEW_READ', 'Veces leída:');
...
define('HEADING_NO_REVIEWS', '<b>No se han escrito comentarios</b>');
define('TEXT_NO_REVIEWS', 'Actualmente no hay comentarios sobre los productos de la tienda. En cuanto un cliente escriba uno se podrá ver aquí.');

define('TEXT_CUSTOMER_RATING', 'Valoración:');
define('TEXT_APPROVED', 'Aprobado');
define('TEXT_APPROVE', 'Aprobar');
define('TEXT_DISAPPROVE', 'Rechazar');
define('TEXT_YES', 'Sí');
define('TEXT_NO', 'No');
?>