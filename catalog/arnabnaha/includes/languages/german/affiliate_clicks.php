...
define('HEADING_TITLE', 'Affiliate Klicks');
...
define('TEXT_NO_CLICKS', 'Es wurden bislang keine Klicks aufgezeichnet');
define('TEXT_DISPLAY_NUMBER_OF_CLICKS', '<b>%d</b> von <b>%d</b> (von <b>%d</b> Klicks)');
?>