...
define('HEADING_TITLE', 'Affiliates FAQ - Häufig gestellte Fragen');

define('TEXT_INFORMATION', '' . STORE_NAME . ' hat diese FAQ geschrieben, um Ihnen die häufigsten Fragen schnell beantworten zu können.<br>
 Falls Sie weitere Fragen haben <a href="' . tep_href_link(FILENAME_AFFILIATE_CONTACT). '"> <u>kontaktieren Sie uns</u></a>.<br>
<ul>
