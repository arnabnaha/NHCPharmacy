<?php
/*
$Id: stats_products_viewed.php 1692 2012-02-26 01:26:50Z michael.oscmax@gmail.com $
...
*/
  ...
  switch($action) {
// reset the admin log
  case 'reset_products_viewed':
	  tep_db_query("update " . TABLE_PRODUCTS_DESCRIPTION . " set products_viewed = '0'");
	  $messageStack->add_session('Best Viewed Products sucessfully reset to zero.', 'success');
	  tep_redirect(tep_href_link(FILENAME_STATS_PRODUCTS_VIEWED));
  break;
  }
?>
...
?>
          ...
          <tr>
            <td colspan="3"><table border="0" width="100%" cellspacing="0" cellpadding="2">
              <tr>
                <td class="smallText" align="left" width="45%"><?php echo $products_split->display_count($products_query_numrows, MAX_DISPLAY_SEARCH_RESULTS, $_GET['page'], TEXT_DISPLAY_NUMBER_OF_PRODUCTS); ?></td>
                <td class="smallText" align="center" width="10%"><?php echo '<a href="' . tep_href_link(FILENAME_STATS_PRODUCTS_VIEWED, 'action=reset_products_viewed') . '">' . tep_image_button('button_reset.gif', IMAGE_RESET) . '</a>'; ?></td>
                <td class="smallText" align="right" width="45%"><?php echo $products_split->display_links($products_query_numrows, MAX_DISPLAY_SEARCH_RESULTS, MAX_DISPLAY_PAGE_LINKS, $_GET['page']); ?></td>
              </tr>
            </table></td>
          </tr>
        </table></td>
