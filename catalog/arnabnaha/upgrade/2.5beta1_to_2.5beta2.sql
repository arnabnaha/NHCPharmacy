#$Id:$
#
# Upgrade database - osCMax v2.5 Beta 1 to v2.5 Beta 2 
#
...
CREATE TABLE IF NOT EXISTS `google_configuration`(
	`google_configuration_key` varchar(255)  NULL  , 
	`google_configuration_value` text  NULL  
);
...
ALTER TABLE `languages` 
	ADD COLUMN `meta_keywords` varchar(255)   NULL after `sort_order`, COMMENT='';
...
DELETE FROM `admin_files`  WHERE (`admin_files_id` = 101) ;
DELETE FROM `admin_files`  WHERE (`admin_files_id` = 99) ;
DELETE FROM `admin_files`  WHERE (`admin_files_id` = 68) ;
DELETE FROM `admin_files`  WHERE (`admin_files_id` = 100) ;

/* SYNC TABLE : `configuration` */

DELETE FROM `configuration`  WHERE (`configuration_id` = 1451) ;
INSERT INTO `configuration` VALUES ('3300', 'Show store opening hours', 'SHOW_STORE_OPENING_HOURS', 'true', 'Do you want to show your store opening hours?', '207', '1', '', '', NULL, 'tep_cfg_select_option(array(\'false\',\'true\'),');
INSERT INTO `configuration` VALUES ('3301', 'Store opening hours text', 'STORE_OPENING_HOURS_TEXT', 'Our store is open from 9.30am to 5pm from Monday to Friday', 'Enter your opening hours.', '207', '2', NULL, '', NULL, 'tep_cfg_textarea(');
INSERT INTO `configuration` VALUES ('2663', 'Main Page Text Information Manager Info Number', 'DEFINE_MAINPAGE_TEXT_INFO_NO', '13', 'What number is the Main Page in the Information Manager? (Default: 13)', '201', '30', '', '', NULL, NULL);
INSERT INTO `configuration` VALUES ('3303', 'Show mailing address', 'SHOW_MAILING_ADDRESS', 'true', 'Do you want to show your mailing address on the contact us page?', '207', '4', '', '', NULL, 'tep_cfg_select_option(array(\'false\',\'true\'),');
INSERT INTO `configuration` VALUES ('1225', 'Absolute path to default banner image', 'AFFILIATE_SHOW_BANNERS_DEFAULT_PIC', 'DIR_WS_IMAGES', 'Full path to default banner which is display incase no other banner can be found', '35', '21', NULL, '', NULL, NULL);
INSERT INTO `configuration` VALUES ('1224', 'Debug Banners', 'AFFILIATE_SHOW_BANNERS_DEBUG', 'false', 'Debug for affiliate_show_banner.php; If you have difficulties geting banners set to true and try to load the banner in a new Browser window', '35', '21', NULL, '', NULL, NULL);
INSERT INTO `configuration` VALUES ('1223', 'Type of banner tracking', 'AFFILIATE_KIND_OF_BANNERS', '2', 'Do you want to track banner impressions.  (1=No; 2=True)', '35', '20', NULL, '', NULL, NULL);
INSERT INTO `configuration` VALUES ('3302', 'Show email address', 'SHOW_EMAIL_ADDRESS', 'true', 'Do you want to show your email address on the contact us page?', '207', '3', '', '', NULL, 'tep_cfg_select_option(array(\'false\',\'true\'),');
INSERT INTO `configuration` VALUES ('392', 'Down For Maintenance Information Manager Code', 'DOWN_FOR_MAINTENANCE_INFO_ID', '12', 'Enter the code from Information Manager which relates to the Down for Maintenance text. (default=12)', '16', '15', NULL, '', NULL, NULL);
INSERT INTO `configuration` VALUES ('2662', 'Display Short Description', 'PRODUCT_SHORT_DESCRIPTION', 'false', 'Do you want to display the short description in the list results?', '8', '6', NULL, '', NULL, 'tep_cfg_select_option(array(\'true\', \'false\'),');
UPDATE `configuration` SET `configuration_id`='2617', `configuration_title`='Set Slideshow width', `configuration_key`='SLIDESHOW_WIDTH', `configuration_value`='640', `configuration_description`='What width do you want your slideshow? (default: 640)', `configuration_group_id`='204', `sort_order`='1', `last_modified`='', `date_added`='', `use_function`=NULL, `set_function`=NULL  WHERE (`configuration_id` = 2617) ;
UPDATE `configuration` SET `configuration_id`='3021', `configuration_title`='Products cellpadding', `configuration_key`='FEATURED_CELLPADDING', `configuration_value`='0', `configuration_description`='Sets the cellpadding for the Products.<br>', `configuration_group_id`='99', `sort_order`='23', `last_modified`='', `date_added`='0000-00-00 00:00:00', `use_function`=NULL, `set_function`=NULL  WHERE (`configuration_id` = 3021) ;
UPDATE `configuration` SET `configuration_id`='3033', `configuration_title`='Manufacturers cellpadding', `configuration_key`='FEATURED_MANUFACTURERS_CELLPADDING', `configuration_value`='0', `configuration_description`='Sets the cellpadding for the manufacturers.<br>', `configuration_group_id`='99', `sort_order`='39', `last_modified`='', `date_added`='0000-00-00 00:00:00', `use_function`=NULL, `set_function`=NULL  WHERE (`configuration_id` = 3033) ;
UPDATE `configuration` SET `configuration_id`='3049', `configuration_title`='Manufacturer with products cellpadding', `configuration_key`='MANUFACTURER_CELLPADDING', `configuration_value`='0', `configuration_description`='Sets the cellpadding for the manufacturer.<br>', `configuration_group_id`='99', `sort_order`='63', `last_modified`='', `date_added`='0000-00-00 00:00:00', `use_function`=NULL, `set_function`=NULL  WHERE (`configuration_id` = 3049) ;
UPDATE `configuration` SET `configuration_id`='3065', `configuration_title`='Categories cellpadding', `configuration_key`='CATEGORIES_CELLPADDING', `configuration_value`='0', `configuration_description`='Sets the cellpadding for the category.<br>', `configuration_group_id`='99', `sort_order`='83', `last_modified`='', `date_added`='0000-00-00 00:00:00', `use_function`=NULL, `set_function`=NULL  WHERE (`configuration_id` = 3065) ;
...
/* SYNC TABLE : `information` */
	...
	/*Start of batch : 1 */
DELETE FROM `information`  WHERE (`information_id` = 5 AND `language_id` = 1) ;
DELETE FROM `information`  WHERE (`information_id` = 4 AND `language_id` = 1) ;
INSERT INTO `information` VALUES ('12', '1', 'Offen f?r Wartung', '<p>Die Website ist derzeit f?r Wartungsarbeiten heruntergefahren. Bitte versuchen Sie es sp?ter noch einmal.</p>', '0', '2', '0', '2');
INSERT INTO `information` VALUES ('2', '2', 'TEXT_GREETING_PERSONAL_RELOGON', '<small>Wenn Sie nicht %s sind, melden Sie sich bitte <a href=\"%s\"><u>hier</u></a> mit Ihrem Kundenkonto an.</small>', '0', '2', '1', '2');
INSERT INTO `information` VALUES ('1', '2', 'TEXT_GREETING_PERSONAL', 'Sch&ouml;n das Sie wieder da sind <span class=\"greetUser\">%s!</span> M&ouml;chten Sie die <a href=\"%s\"><u>neue Produkte</u></a> ansehen?', '0', '1', '1', '2');
INSERT INTO `information` VALUES ('12', '1', 'Cerrado por mantenimiento', '<p>El sitio est? actualmente cerrado por mantenimiento. Por favor, int?ntelo de nuevo m?s tarde.</p>', '0', '2', '0', '3');
INSERT INTO `information` VALUES ('3', '2', 'TEXT_GREETING_GUEST', 'Herzlich Willkommen <span class=\"greetUser\">Gast!</span> M&ouml;chten Sie sich <a href=\"%s\"><u>anmelden</u></a>? Oder wollen Sie ein <a href=\"%s\"><u>Kundenkonto</u></a> er&ouml;ffnen?', '0', '3', '1', '2');
INSERT INTO `information` VALUES ('3', '2', 'TEXT_GREETING_GUEST', 'Bienvenido <span class=\"greetUser\">Invitado!</span> &iquest;Le gustaria <a href=\"%s\"><u>entrar en su cuenta</u></a> o preferiria <a href=\"%s\"><u>crear una cuenta nueva</u></a>?', '0', '3', '1', '3');
INSERT INTO `information` VALUES ('2', '2', 'TEXT_GREETING_PERSONAL_RELOGON', '<small>Si no es %s, por favor <a href=\"%s\"><u>entre aqui</u></a> e introduzca sus datos.</small>', '0', '2', '1', '3');
INSERT INTO `information` VALUES ('1', '2', 'TEXT_GREETING_PERSONAL', 'Bienvenido de nuevo <span class=\"greetUser\">%s!</span> &iquest;Le gustaria ver que <a href=\"%s\"><u>nuevos productos</u></a> hay disponibles?', '0', '1', '1', '3');
INSERT INTO `information` VALUES ('14', '1', 'Afiliados T?rminos y Condiciones', 'Introduzca los t?rminos de afiliados y condiciones aqu', '0', '7', '0', '3');
INSERT INTO `information` VALUES ('14', '1', 'Affiliate AGB', 'Legen Sie Ihre Affiliate-Bedingungen hier.', '0', '7', '0', '2');
...
INSERT INTO `information` VALUES ('13', '1', '?ndice Texto p?gina', '<p><font face=\"arial, helvetica, sans-serif\">Para modificar el contenido de esta p?gina, vaya al Panel de Administraci?n -> Configuraci?n -> Plantillas -> Administrador de informaci?n.</font></p><hr /><p><font face=\"arial, helvetica, sans-serif\">Esto es osCmax v2.5, el poder de compras de comercio electr?nico sistema del carro.</font></p><p><font face=\"Arial\">El funcionario de Apoyo osCMax es http://www.oscmax.com. Hay foros de soporte muy activo, wiki, documentaci?n, descargas y todo lo relacionado con osCmax.</font></p>', '0', '1', '0', '3');
...
UPDATE `zones` SET `zone_id`='284', `zone_country_id`='15', `zone_code`='SAR', `zone_name`='Sarur'  WHERE (`zone_id` = 284) ;
UPDATE `zones` SET `zone_id`='283', `zone_country_id`='15', `zone_code`='SMX', `zone_name`='Samux'  WHERE (`zone_id` = 283) ;
UPDATE `zones` SET `zone_id`='282', `zone_country_id`='15', `zone_code`='SKR', `zone_name`='Samkir'  WHERE (`zone_id` = 282) ;
UPDATE `zones` SET `zone_id`='281', `zone_country_id`='15', `zone_code`='SMI', `zone_name`='Samaxi'  WHERE (`zone_id` = 281) ;
UPDATE `zones` SET `zone_id`='280', `zone_country_id`='15', `zone_code`='SM', `zone_name`='Sumqayit'  WHERE (`zone_id` = 280) ;
UPDATE `zones` SET `zone_id`='279', `zone_country_id`='15', `zone_code`='SAL', `zone_name`='Salyan'  WHERE (`zone_id` = 279) ;
UPDATE `zones` SET `zone_id`='278', `zone_country_id`='15', `zone_code`='SAK', `zone_name`='Saki'  WHERE (`zone_id` = 278) ;
UPDATE `zones` SET `zone_id`='277', `zone_country_id`='15', `zone_code`='SAH', `zone_name`='Sahbuz'  WHERE (`zone_id` = 277) ;
UPDATE `zones` SET `zone_id`='276', `zone_country_id`='15', `zone_code`='SAD', `zone_name`='Sadarak'  WHERE (`zone_id` = 276) ;
UPDATE `zones` SET `zone_id`='275', `zone_country_id`='15', `zone_code`='SAB', `zone_name`='Sabirabad'  WHERE (`zone_id` = 275) ;
UPDATE `zones` SET `zone_id`='274', `zone_country_id`='15', `zone_code`='SAT', `zone_name`='Saatli'  WHERE (`zone_id` = 274) ;
UPDATE `zones` SET `zone_id`='273', `zone_country_id`='15', `zone_code`='SA', `zone_name`='Saki'  WHERE (`zone_id` = 273) ;
UPDATE `zones` SET `zone_id`='272', `zone_country_id`='15', `zone_code`='QUS', `zone_name`='Qusar'  WHERE (`zone_id` = 272) ;
UPDATE `zones` SET `zone_id`='271', `zone_country_id`='15', `zone_code`='QBI', `zone_name`='Qubadli'  WHERE (`zone_id` = 271) ;
UPDATE `zones` SET `zone_id`='270', `zone_country_id`='15', `zone_code`='QBA', `zone_name`='Quba'  WHERE (`zone_id` = 270) ;
UPDATE `zones` SET `zone_id`='269', `zone_country_id`='15', `zone_code`='QOB', `zone_name`='Qobustan'  WHERE (`zone_id` = 269) ;
UPDATE `zones` SET `zone_id`='268', `zone_country_id`='15', `zone_code`='QAZ', `zone_name`='Qazax'  WHERE (`zone_id` = 268) ;
UPDATE `zones` SET `zone_id`='267', `zone_country_id`='15', `zone_code`='QAX', `zone_name`='Qax'  WHERE (`zone_id` = 267) ;
UPDATE `zones` SET `zone_id`='266', `zone_country_id`='15', `zone_code`='QAB', `zone_name`='Qabala'  WHERE (`zone_id` = 266) ;
UPDATE `zones` SET `zone_id`='265', `zone_country_id`='15', `zone_code`='ORD', `zone_name`='Ordubad'  WHERE (`zone_id` = 265) ;
UPDATE `zones` SET `zone_id`='264', `zone_country_id`='15', `zone_code`='OGU', `zone_name`='Oguz'  WHERE (`zone_id` = 264) ;
UPDATE `zones` SET `zone_id`='263', `zone_country_id`='15', `zone_code`='NEF', `zone_name`='Neftcala'  WHERE (`zone_id` = 263) ;
UPDATE `zones` SET `zone_id`='262', `zone_country_id`='15', `zone_code`='NA', `zone_name`='Naftalan'  WHERE (`zone_id` = 262) ;
UPDATE `zones` SET `zone_id`='261', `zone_country_id`='15', `zone_code`='MI', `zone_name`='Mingacevir'  WHERE (`zone_id` = 261) ;
UPDATE `zones` SET `zone_id`='260', `zone_country_id`='15', `zone_code`='MAS', `zone_name`='Masalli'  WHERE (`zone_id` = 260) ;
UPDATE `zones` SET `zone_id`='259', `zone_country_id`='15', `zone_code`='LER', `zone_name`='Lerik'  WHERE (`zone_id` = 259) ;
UPDATE `zones` SET `zone_id`='258', `zone_country_id`='15', `zone_code`='LAN', `zone_name`='Lankaran'  WHERE (`zone_id` = 258) ;
UPDATE `zones` SET `zone_id`='257', `zone_country_id`='15', `zone_code`='LAC', `zone_name`='Lacin'  WHERE (`zone_id` = 257) ;
UPDATE `zones` SET `zone_id`='256', `zone_country_id`='15', `zone_code`='LA', `zone_name`='Lankaran'  WHERE (`zone_id` = 256) ;
UPDATE `zones` SET `zone_id`='255', `zone_country_id`='15', `zone_code`='KUR', `zone_name`='Kurdamir'  WHERE (`zone_id` = 255) ;
UPDATE `zones` SET `zone_id`='254', `zone_country_id`='15', `zone_code`='KAL', `zone_name`='Kalbacar'  WHERE (`zone_id` = 254) ;
UPDATE `zones` SET `zone_id`='253', `zone_country_id`='15', `zone_code`='ISM', `zone_name`='Ismayilli'  WHERE (`zone_id` = 253) ;
UPDATE `zones` SET `zone_id`='252', `zone_country_id`='15', `zone_code`='IMI', `zone_name`='Imisli'  WHERE (`zone_id` = 252) ;
UPDATE `zones` SET `zone_id`='251', `zone_country_id`='15', `zone_code`='HAC', `zone_name`='Haciqabul'  WHERE (`zone_id` = 251) ;
UPDATE `zones` SET `zone_id`='250', `zone_country_id`='15', `zone_code`='GOY', `zone_name`='Goycay'  WHERE (`zone_id` = 250) ;
UPDATE `zones` SET `zone_id`='249', `zone_country_id`='15', `zone_code`='GOR', `zone_name`='Goranboy'  WHERE (`zone_id` = 249) ;
UPDATE `zones` SET `zone_id`='248', `zone_country_id`='15', `zone_code`='GAD', `zone_name`='Gadabay'  WHERE (`zone_id` = 248) ;
UPDATE `zones` SET `zone_id`='247', `zone_country_id`='15', `zone_code`='GA', `zone_name`='Ganca'  WHERE (`zone_id` = 247) ;
UPDATE `zones` SET `zone_id`='246', `zone_country_id`='15', `zone_code`='FUZ', `zone_name`='Fuzuli'  WHERE (`zone_id` = 246) ;
UPDATE `zones` SET `zone_id`='245', `zone_country_id`='15', `zone_code`='DAV', `zone_name`='Davaci'  WHERE (`zone_id` = 245) ;
UPDATE `zones` SET `zone_id`='244', `zone_country_id`='15', `zone_code`='DAS', `zone_name`='Daskasan'  WHERE (`zone_id` = 244) ;
UPDATE `zones` SET `zone_id`='243', `zone_country_id`='15', `zone_code`='CUL', `zone_name`='Culfa'  WHERE (`zone_id` = 243) ;
UPDATE `zones` SET `zone_id`='242', `zone_country_id`='15', `zone_code`='CAL', `zone_name`='Calilabab'  WHERE (`zone_id` = 242) ;
UPDATE `zones` SET `zone_id`='241', `zone_country_id`='15', `zone_code`='CAB', `zone_name`='Cabrayil'  WHERE (`zone_id` = 241) ;
UPDATE `zones` SET `zone_id`='240', `zone_country_id`='15', `zone_code`='BIL', `zone_name`='Bilasuvar'  WHERE (`zone_id` = 240) ;
UPDATE `zones` SET `zone_id`='239', `zone_country_id`='15', `zone_code`='BEY', `zone_name`='Beylaqan'  WHERE (`zone_id` = 239) ;
UPDATE `zones` SET `zone_id`='238', `zone_country_id`='15', `zone_code`='BAR', `zone_name`='BArdA'  WHERE (`zone_id` = 238) ;
UPDATE `zones` SET `zone_id`='237', `zone_country_id`='15', `zone_code`='BAL', `zone_name`='BalakAn'  WHERE (`zone_id` = 237) ;
UPDATE `zones` SET `zone_id`='236', `zone_country_id`='15', `zone_code`='BAB', `zone_name`='BabAk'  WHERE (`zone_id` = 236) ;
UPDATE `zones` SET `zone_id`='235', `zone_country_id`='15', `zone_code`='BA', `zone_name`='Baki'  WHERE (`zone_id` = 235) ;
UPDATE `zones` SET `zone_id`='234', `zone_country_id`='15', `zone_code`='AST', `zone_name`='Astara'  WHERE (`zone_id` = 234) ;
UPDATE `zones` SET `zone_id`='233', `zone_country_id`='15', `zone_code`='AGU', `zone_name`='Agsu'  WHERE (`zone_id` = 233) ;
UPDATE `zones` SET `zone_id`='232', `zone_country_id`='15', `zone_code`='AGA', `zone_name`='Agstafa'  WHERE (`zone_id` = 232) ;
UPDATE `zones` SET `zone_id`='231', `zone_country_id`='15', `zone_code`='AGS', `zone_name`='Agdas'  WHERE (`zone_id` = 231) ;
UPDATE `zones` SET `zone_id`='230', `zone_country_id`='15', `zone_code`='AGM', `zone_name`='Agdam'  WHERE (`zone_id` = 230) ;
UPDATE `zones` SET `zone_id`='229', `zone_country_id`='15', `zone_code`='AGC', `zone_name`='AgcabAdi'  WHERE (`zone_id` = 229) ;
UPDATE `zones` SET `zone_id`='228', `zone_country_id`='15', `zone_code`='ABS', `zone_name`='Abseron'  WHERE (`zone_id` = 228) ;
UPDATE `zones` SET `zone_id`='227', `zone_country_id`='15', `zone_code`='AB', `zone_name`='Ali Bayramli'  WHERE (`zone_id` = 227) ;
UPDATE `zones` SET `zone_id`='226', `zone_country_id`='14', `zone_code`='WIE', `zone_name`='Wien'  WHERE (`zone_id` = 226) ;
UPDATE `zones` SET `zone_id`='225', `zone_country_id`='14', `zone_code`='VOR', `zone_name`='Vorarlberg'  WHERE (`zone_id` = 225) ;
UPDATE `zones` SET `zone_id`='224', `zone_country_id`='14', `zone_code`='TIR', `zone_name`='Tirol'  WHERE (`zone_id` = 224) ;
UPDATE `zones` SET `zone_id`='223', `zone_country_id`='14', `zone_code`='STE', `zone_name`='Steiermark'  WHERE (`zone_id` = 223) ;
UPDATE `zones` SET `zone_id`='222', `zone_country_id`='14', `zone_code`='SAL', `zone_name`='Salzburg'  WHERE (`zone_id` = 222) ;
UPDATE `zones` SET `zone_id`='221', `zone_country_id`='14', `zone_code`='OOS', `zone_name`='Ober&ouml;esterreich'  WHERE (`zone_id` = 221) ;
UPDATE `zones` SET `zone_id`='220', `zone_country_id`='14', `zone_code`='NOS', `zone_name`='Nieder&ouml;esterreich'  WHERE (`zone_id` = 220) ;
UPDATE `zones` SET `zone_id`='219', `zone_country_id`='14', `zone_code`='KAR', `zone_name`='K&auml;rnten'  WHERE (`zone_id` = 219) ;
UPDATE `zones` SET `zone_id`='218', `zone_country_id`='14', `zone_code`='BUR', `zone_name`='Burgenland'  WHERE (`zone_id` = 218) ;
UPDATE `zones` SET `zone_id`='217', `zone_country_id`='13', `zone_code`='WA', `zone_name`='Western Australia'  WHERE (`zone_id` = 217) ;
UPDATE `zones` SET `zone_id`='216', `zone_country_id`='13', `zone_code`='VIC', `zone_name`='Victoria'  WHERE (`zone_id` = 216) ;
UPDATE `zones` SET `zone_id`='215', `zone_country_id`='13', `zone_code`='TAS', `zone_name`='Tasmania'  WHERE (`zone_id` = 215) ;
UPDATE `zones` SET `zone_id`='214', `zone_country_id`='13', `zone_code`='SA', `zone_name`='South Australia'  WHERE (`zone_id` = 214) ;
UPDATE `zones` SET `zone_id`='213', `zone_country_id`='13', `zone_code`='QLD', `zone_name`='Queensland'  WHERE (`zone_id` = 213) ;
UPDATE `zones` SET `zone_id`='212', `zone_country_id`='13', `zone_code`='NT', `zone_name`='Northern Territory'  WHERE (`zone_id` = 212) ;
UPDATE `zones` SET `zone_id`='211', `zone_country_id`='13', `zone_code`='NSW', `zone_name`='New South Wales'  WHERE (`zone_id` = 211) ;
UPDATE `zones` SET `zone_id`='210', `zone_country_id`='13', `zone_code`='ACT', `zone_name`='Australian Capital Territory'  WHERE (`zone_id` = 210) ;
UPDATE `zones` SET `zone_id`='209', `zone_country_id`='12', `zone_code`='WAY', `zone_name`='Wayaca'  WHERE (`zone_id` = 209) ;
UPDATE `zones` SET `zone_id`='208', `zone_country_id`='12', `zone_code`='SIN', `zone_name`='Sint Nicolas'  WHERE (`zone_id` = 208) ;
UPDATE `zones` SET `zone_id`='207', `zone_country_id`='12', `zone_code`='SIN', `zone_name`='Sint Nicolaas'  WHERE (`zone_id` = 207) ;
UPDATE `zones` SET `zone_id`='206', `zone_country_id`='12', `zone_code`='ROO', `zone_name`='Rooi Thomas'  WHERE (`zone_id` = 206) ;
UPDATE `zones` SET `zone_id`='205', `zone_country_id`='12', `zone_code`='PAL', `zone_name`='Palm Beach'  WHERE (`zone_id` = 205) ;
UPDATE `zones` SET `zone_id`='204', `zone_country_id`='12', `zone_code`='NOO', `zone_name`='Noord'  WHERE (`zone_id` = 204) ;
UPDATE `zones` SET `zone_id`='203', `zone_country_id`='12', `zone_code`='MAN', `zone_name`='Manchebo Beach'  WHERE (`zone_id` = 203) ;
UPDATE `zones` SET `zone_id`='202', `zone_country_id`='12', `zone_code`='DRU', `zone_name`='Druif Beach'  WHERE (`zone_id` = 202) ;
UPDATE `zones` SET `zone_id`='201', `zone_country_id`='12', `zone_code`='ORA', `zone_name`='Oranjestad'  WHERE (`zone_id` = 201) ;
UPDATE `zones` SET `zone_id`='200', `zone_country_id`='12', `zone_code`='ARU', `zone_name`='Aruba'  WHERE (`zone_id` = 200) ;
UPDATE `zones` SET `zone_id`='199', `zone_country_id`='11', `zone_code`='YER', `zone_name`='Yerevan'  WHERE (`zone_id` = 199) ;
UPDATE `zones` SET `zone_id`='198', `zone_country_id`='11', `zone_code`='VAY', `zone_name`='Vayots\' Dzor'  WHERE (`zone_id` = 198) ;
UPDATE `zones` SET `zone_id`='197', `zone_country_id`='11', `zone_code`='TAV', `zone_name`='Tavush'  WHERE (`zone_id` = 197) ;
UPDATE `zones` SET `zone_id`='196', `zone_country_id`='11', `zone_code`='SYU', `zone_name`='Syunik\''  WHERE (`zone_id` = 196) ;
UPDATE `zones` SET `zone_id`='195', `zone_country_id`='11', `zone_code`='SHI', `zone_name`='Shirak'  WHERE (`zone_id` = 195) ;
UPDATE `zones` SET `zone_id`='194', `zone_country_id`='11', `zone_code`='LOR', `zone_name`='Lorri'  WHERE (`zone_id` = 194) ;
UPDATE `zones` SET `zone_id`='193', `zone_country_id`='11', `zone_code`='KOT', `zone_name`='Kotayk\''  WHERE (`zone_id` = 193) ;
UPDATE `zones` SET `zone_id`='192', `zone_country_id`='11', `zone_code`='GEG', `zone_name`='Geghark\'unik\''  WHERE (`zone_id` = 192) ;
UPDATE `zones` SET `zone_id`='191', `zone_country_id`='11', `zone_code`='ARM', `zone_name`='Armavir'  WHERE (`zone_id` = 191) ;
UPDATE `zones` SET `zone_id`='190', `zone_country_id`='11', `zone_code`='ARR', `zone_name`='Ararat'  WHERE (`zone_id` = 190) ;
UPDATE `zones` SET `zone_id`='189', `zone_country_id`='11', `zone_code`='AGT', `zone_name`='Aragatsotn'  WHERE (`zone_id` = 189) ;
UPDATE `zones` SET `zone_id`='188', `zone_country_id`='10', `zone_code`='TU', `zone_name`='Tucuman'  WHERE (`zone_id` = 188) ;
UPDATE `zones` SET `zone_id`='187', `zone_country_id`='10', `zone_code`='TF', `zone_name`='Tierra del Fuego'  WHERE (`zone_id` = 187) ;
UPDATE `zones` SET `zone_id`='186', `zone_country_id`='10', `zone_code`='SD', `zone_name`='Santiago del Estero'  WHERE (`zone_id` = 186) ;
UPDATE `zones` SET `zone_id`='185', `zone_country_id`='10', `zone_code`='SF', `zone_name`='Santa Fe'  WHERE (`zone_id` = 185) ;
UPDATE `zones` SET `zone_id`='184', `zone_country_id`='10', `zone_code`='SC', `zone_name`='Santa Cruz'  WHERE (`zone_id` = 184) ;
UPDATE `zones` SET `zone_id`='183', `zone_country_id`='10', `zone_code`='SL', `zone_name`='San Luis'  WHERE (`zone_id` = 183) ;
UPDATE `zones` SET `zone_id`='182', `zone_country_id`='10', `zone_code`='SJ', `zone_name`='San Juan'  WHERE (`zone_id` = 182) ;
UPDATE `zones` SET `zone_id`='181', `zone_country_id`='10', `zone_code`='SA', `zone_name`='Salta'  WHERE (`zone_id` = 181) ;
UPDATE `zones` SET `zone_id`='180', `zone_country_id`='10', `zone_code`='RN', `zone_name`='Rio Negro'  WHERE (`zone_id` = 180) ;
UPDATE `zones` SET `zone_id`='179', `zone_country_id`='10', `zone_code`='NE', `zone_name`='Neuquen'  WHERE (`zone_id` = 179) ;
UPDATE `zones` SET `zone_id`='178', `zone_country_id`='10', `zone_code`='MI', `zone_name`='Misiones'  WHERE (`zone_id` = 178) ;
UPDATE `zones` SET `zone_id`='177', `zone_country_id`='10', `zone_code`='ME', `zone_name`='Mendoza'  WHERE (`zone_id` = 177) ;
UPDATE `zones` SET `zone_id`='176', `zone_country_id`='10', `zone_code`='LR', `zone_name`='La Rioja'  WHERE (`zone_id` = 176) ;
UPDATE `zones` SET `zone_id`='175', `zone_country_id`='10', `zone_code`='LP', `zone_name`='La Pampa'  WHERE (`zone_id` = 175) ;
UPDATE `zones` SET `zone_id`='174', `zone_country_id`='10', `zone_code`='JU', `zone_name`='Jujuy'  WHERE (`zone_id` = 174) ;
UPDATE `zones` SET `zone_id`='173', `zone_country_id`='10', `zone_code`='FO', `zone_name`='Formosa'  WHERE (`zone_id` = 173) ;
UPDATE `zones` SET `zone_id`='172', `zone_country_id`='10', `zone_code`='ER', `zone_name`='Entre Rios'  WHERE (`zone_id` = 172) ;
UPDATE `zones` SET `zone_id`='171', `zone_country_id`='10', `zone_code`='CF', `zone_name`='Capital Federal'  WHERE (`zone_id` = 171) ;
UPDATE `zones` SET `zone_id`='170', `zone_country_id`='10', `zone_code`='CR', `zone_name`='Corrientes'  WHERE (`zone_id` = 170) ;
UPDATE `zones` SET `zone_id`='169', `zone_country_id`='10', `zone_code`='CO', `zone_name`='Cordoba'  WHERE (`zone_id` = 169) ;
UPDATE `zones` SET `zone_id`='168', `zone_country_id`='10', `zone_code`='CU', `zone_name`='Chubut'  WHERE (`zone_id` = 168) ;
UPDATE `zones` SET `zone_id`='167', `zone_country_id`='10', `zone_code`='CH', `zone_name`='Chaco'  WHERE (`zone_id` = 167) ;
UPDATE `zones` SET `zone_id`='166', `zone_country_id`='10', `zone_code`='CA', `zone_name`='Catamarca'  WHERE (`zone_id` = 166) ;
UPDATE `zones` SET `zone_id`='165', `zone_country_id`='10', `zone_code`='BA', `zone_name`='Buenos Aires'  WHERE (`zone_id` = 165) ;
UPDATE `zones` SET `zone_id`='164', `zone_country_id`='10', `zone_code`='AN', `zone_name`='Antartida e Islas del Atlantico'  WHERE (`zone_id` = 164) ;
UPDATE `zones` SET `zone_id`='163', `zone_country_id`='9', `zone_code`='RED', `zone_name`='Redonda'  WHERE (`zone_id` = 163) ;
UPDATE `zones` SET `zone_id`='162', `zone_country_id`='9', `zone_code`='BAR', `zone_name`='Barbuda'  WHERE (`zone_id` = 162) ;
UPDATE `zones` SET `zone_id`='161', `zone_country_id`='9', `zone_code`='ASH', `zone_name`='Saint Philip'  WHERE (`zone_id` = 161) ;
UPDATE `zones` SET `zone_id`='160', `zone_country_id`='9', `zone_code`='ASR', `zone_name`='Saint Peter'  WHERE (`zone_id` = 160) ;
UPDATE `zones` SET `zone_id`='159', `zone_country_id`='9', `zone_code`='ASL', `zone_name`='Saint Paul'  WHERE (`zone_id` = 159) ;
UPDATE `zones` SET `zone_id`='158', `zone_country_id`='9', `zone_code`='ASM', `zone_name`='Saint Mary'  WHERE (`zone_id` = 158) ;
UPDATE `zones` SET `zone_id`='157', `zone_country_id`='9', `zone_code`='ASJ', `zone_name`='Saint John'  WHERE (`zone_id` = 157) ;
UPDATE `zones` SET `zone_id`='156', `zone_country_id`='9', `zone_code`='ASG', `zone_name`='Saint George'  WHERE (`zone_id` = 156) ;
UPDATE `zones` SET `zone_id`='155', `zone_country_id`='7', `zone_code`='SOM', `zone_name`='Sombrero'  WHERE (`zone_id` = 155) ;
UPDATE `zones` SET `zone_id`='154', `zone_country_id`='7', `zone_code`='SEA', `zone_name`='Seal'  WHERE (`zone_id` = 154) ;
UPDATE `zones` SET `zone_id`='153', `zone_country_id`='7', `zone_code`='ANG', `zone_name`='Anguila'  WHERE (`zone_id` = 153) ;
UPDATE `zones` SET `zone_id`='152', `zone_country_id`='7', `zone_code`='ANG', `zone_name`='Anguillita'  WHERE (`zone_id` = 152) ;
UPDATE `zones` SET `zone_id`='151', `zone_country_id`='7', `zone_code`='DOG', `zone_name`='Dog'  WHERE (`zone_id` = 151) ;
UPDATE `zones` SET `zone_id`='150', `zone_country_id`='7', `zone_code`='LIT', `zone_name`='Little Scrub'  WHERE (`zone_id` = 150) ;
UPDATE `zones` SET `zone_id`='149', `zone_country_id`='7', `zone_code`='PRI', `zone_name`='Prickly Pear'  WHERE (`zone_id` = 149) ;
UPDATE `zones` SET `zone_id`='148', `zone_country_id`='7', `zone_code`='SAN', `zone_name`='Sandy'  WHERE (`zone_id` = 148) ;
UPDATE `zones` SET `zone_id`='147', `zone_country_id`='7', `zone_code`='SCR', `zone_name`='Scrub'  WHERE (`zone_id` = 147) ;
UPDATE `zones` SET `zone_id`='146', `zone_country_id`='6', `zone_code`='ZAI', `zone_name`='Zaire'  WHERE (`zone_id` = 146) ;
UPDATE `zones` SET `zone_id`='145', `zone_country_id`='6', `zone_code`='UIG', `zone_name`='Uige'  WHERE (`zone_id` = 145) ;
UPDATE `zones` SET `zone_id`='144', `zone_country_id`='6', `zone_code`='NAM', `zone_name`='Namibe'  WHERE (`zone_id` = 144) ;
UPDATE `zones` SET `zone_id`='143', `zone_country_id`='6', `zone_code`='MOX', `zone_name`='Moxico'  WHERE (`zone_id` = 143) ;
UPDATE `zones` SET `zone_id`='142', `zone_country_id`='6', `zone_code`='MAL', `zone_name`='Malange'  WHERE (`zone_id` = 142) ;
UPDATE `zones` SET `zone_id`='141', `zone_country_id`='6', `zone_code`='LSU', `zone_name`='Lunda Sul'  WHERE (`zone_id` = 141) ;
UPDATE `zones` SET `zone_id`='140', `zone_country_id`='6', `zone_code`='LNO', `zone_name`='Lunda Norte'  WHERE (`zone_id` = 140) ;
UPDATE `zones` SET `zone_id`='139', `zone_country_id`='6', `zone_code`='LUA', `zone_name`='Luanda'  WHERE (`zone_id` = 139) ;
UPDATE `zones` SET `zone_id`='138', `zone_country_id`='6', `zone_code`='HUI', `zone_name`='Huila'  WHERE (`zone_id` = 138) ;
UPDATE `zones` SET `zone_id`='137', `zone_country_id`='6', `zone_code`='HUA', `zone_name`='Huambo'  WHERE (`zone_id` = 137) ;
UPDATE `zones` SET `zone_id`='136', `zone_country_id`='6', `zone_code`='CNN', `zone_name`='Cunene'  WHERE (`zone_id` = 136) ;
UPDATE `zones` SET `zone_id`='135', `zone_country_id`='6', `zone_code`='CUS', `zone_name`='Cuanza Sul'  WHERE (`zone_id` = 135) ;
UPDATE `zones` SET `zone_id`='134', `zone_country_id`='6', `zone_code`='CNO', `zone_name`='Cuanza Norte'  WHERE (`zone_id` = 134) ;
UPDATE `zones` SET `zone_id`='133', `zone_country_id`='6', `zone_code`='CCU', `zone_name`='Cuando-Cubango'  WHERE (`zone_id` = 133) ;
UPDATE `zones` SET `zone_id`='132', `zone_country_id`='6', `zone_code`='CAB', `zone_name`='Cabinda'  WHERE (`zone_id` = 132) ;
UPDATE `zones` SET `zone_id`='131', `zone_country_id`='6', `zone_code`='BIE', `zone_name`='Bie'  WHERE (`zone_id` = 131) ;
UPDATE `zones` SET `zone_id`='130', `zone_country_id`='6', `zone_code`='BGU', `zone_name`='Benguela'  WHERE (`zone_id` = 130) ;
UPDATE `zones` SET `zone_id`='129', `zone_country_id`='6', `zone_code`='BGO', `zone_name`='Bengo'  WHERE (`zone_id` = 129) ;
UPDATE `zones` SET `zone_id`='128', `zone_country_id`='5', `zone_code`='SJL', `zone_name`='Sant JuliÃ  de LÃ²ria'  WHERE (`zone_id` = 128) ;
UPDATE `zones` SET `zone_id`='127', `zone_country_id`='5', `zone_code`='ORD', `zone_name`='Ordino'  WHERE (`zone_id` = 127) ;
UPDATE `zones` SET `zone_id`='126', `zone_country_id`='5', `zone_code`='LMA', `zone_name`='La Massana'  WHERE (`zone_id` = 126) ;
UPDATE `zones` SET `zone_id`='125', `zone_country_id`='5', `zone_code`='ESE', `zone_name`='Escaldes-Engordany'  WHERE (`zone_id` = 125) ;
UPDATE `zones` SET `zone_id`='124', `zone_country_id`='5', `zone_code`='ENC', `zone_name`='Encamp'  WHERE (`zone_id` = 124) ;
UPDATE `zones` SET `zone_id`='123', `zone_country_id`='5', `zone_code`='CAN', `zone_name`='Canillo'  WHERE (`zone_id` = 123) ;
UPDATE `zones` SET `zone_id`='122', `zone_country_id`='5', `zone_code`='ALV', `zone_name`='Andorra la Vella'  WHERE (`zone_id` = 122) ;
UPDATE `zones` SET `zone_id`='121', `zone_country_id`='4', `zone_code`='W', `zone_name`='Western'  WHERE (`zone_id` = 121) ;
UPDATE `zones` SET `zone_id`='120', `zone_country_id`='4', `zone_code`='S', `zone_name`='Swains Island'  WHERE (`zone_id` = 120) ;
UPDATE `zones` SET `zone_id`='119', `zone_country_id`='4', `zone_code`='R', `zone_name`='Rose Island'  WHERE (`zone_id` = 119) ;
UPDATE `zones` SET `zone_id`='118', `zone_country_id`='4', `zone_code`='M', `zone_name`='Manu\'a'  WHERE (`zone_id` = 118) ;
UPDATE `zones` SET `zone_id`='117', `zone_country_id`='4', `zone_code`='E', `zone_name`='Eastern'  WHERE (`zone_id` = 117) ;
UPDATE `zones` SET `zone_id`='116', `zone_country_id`='3', `zone_code`='TLE', `zone_name`='Tlemcen'  WHERE (`zone_id` = 116) ;
UPDATE `zones` SET `zone_id`='115', `zone_country_id`='3', `zone_code`='TOU', `zone_name`='Tizi Ouzou'  WHERE (`zone_id` = 115) ;
UPDATE `zones` SET `zone_id`='114', `zone_country_id`='3', `zone_code`='TIS', `zone_name`='Tissemsilt'  WHERE (`zone_id` = 114) ;
UPDATE `zones` SET `zone_id`='113', `zone_country_id`='3', `zone_code`='TIP', `zone_name`='Tipaza'  WHERE (`zone_id` = 113) ;
UPDATE `zones` SET `zone_id`='112', `zone_country_id`='3', `zone_code`='TIN', `zone_name`='Tindouf'  WHERE (`zone_id` = 112) ;
UPDATE `zones` SET `zone_id`='111', `zone_country_id`='3', `zone_code`='TIA', `zone_name`='Tiaret'  WHERE (`zone_id` = 111) ;
UPDATE `zones` SET `zone_id`='110', `zone_country_id`='3', `zone_code`='TEB', `zone_name`='Tebessa'  WHERE (`zone_id` = 110) ;
UPDATE `zones` SET `zone_id`='109', `zone_country_id`='3', `zone_code`='TAM', `zone_name`='Tamanghasset'  WHERE (`zone_id` = 109) ;
UPDATE `zones` SET `zone_id`='108', `zone_country_id`='3', `zone_code`='SAH', `zone_name`='Souk Ahras'  WHERE (`zone_id` = 108) ;
UPDATE `zones` SET `zone_id`='107', `zone_country_id`='3', `zone_code`='SKI', `zone_name`='Skikda'  WHERE (`zone_id` = 107) ;
UPDATE `zones` SET `zone_id`='106', `zone_country_id`='3', `zone_code`='SBA', `zone_name`='Sidi Bel Abbes'  WHERE (`zone_id` = 106) ;
UPDATE `zones` SET `zone_id`='105', `zone_country_id`='3', `zone_code`='SET', `zone_name`='Setif'  WHERE (`zone_id` = 105) ;
UPDATE `zones` SET `zone_id`='104', `zone_country_id`='3', `zone_code`='SAI', `zone_name`='Saida'  WHERE (`zone_id` = 104) ;
UPDATE `zones` SET `zone_id`='103', `zone_country_id`='3', `zone_code`='REL', `zone_name`='Relizane'  WHERE (`zone_id` = 103) ;
UPDATE `zones` SET `zone_id`='102', `zone_country_id`='3', `zone_code`='OEB', `zone_name`='Oum el-Bouaghi'  WHERE (`zone_id` = 102) ;
UPDATE `zones` SET `zone_id`='101', `zone_country_id`='3', `zone_code`='OUA', `zone_name`='Ouargla'  WHERE (`zone_id` = 101) ;
UPDATE `zones` SET `zone_id`='100', `zone_country_id`='3', `zone_code`='ORA', `zone_name`='Oran'  WHERE (`zone_id` = 100) ;
UPDATE `zones` SET `zone_id`='99', `zone_country_id`='3', `zone_code`='NAA', `zone_name`='Naama'  WHERE (`zone_id` = 99) ;
UPDATE `zones` SET `zone_id`='98', `zone_country_id`='3', `zone_code`='MSI', `zone_name`='M\'Sila'  WHERE (`zone_id` = 98) ;
UPDATE `zones` SET `zone_id`='97', `zone_country_id`='3', `zone_code`='MOS', `zone_name`='Mostaganem'  WHERE (`zone_id` = 97) ;
UPDATE `zones` SET `zone_id`='96', `zone_country_id`='3', `zone_code`='MIL', `zone_name`='Mila'  WHERE (`zone_id` = 96) ;
UPDATE `zones` SET `zone_id`='95', `zone_country_id`='3', `zone_code`='MED', `zone_name`='Medea'  WHERE (`zone_id` = 95) ;
UPDATE `zones` SET `zone_id`='94', `zone_country_id`='3', `zone_code`='MUA', `zone_name`='Muaskar'  WHERE (`zone_id` = 94) ;
UPDATE `zones` SET `zone_id`='93', `zone_country_id`='3', `zone_code`='LAG', `zone_name`='Laghouat'  WHERE (`zone_id` = 93) ;
UPDATE `zones` SET `zone_id`='92', `zone_country_id`='3', `zone_code`='KHE', `zone_name`='Khenchela'  WHERE (`zone_id` = 92) ;
UPDATE `zones` SET `zone_id`='91', `zone_country_id`='3', `zone_code`='JIJ', `zone_name`='Jijel'  WHERE (`zone_id` = 91) ;
UPDATE `zones` SET `zone_id`='90', `zone_country_id`='3', `zone_code`='ILL', `zone_name`='Illizi'  WHERE (`zone_id` = 90) ;
UPDATE `zones` SET `zone_id`='89', `zone_country_id`='3', `zone_code`='GUE', `zone_name`='Guelma'  WHERE (`zone_id` = 89) ;
UPDATE `zones` SET `zone_id`='88', `zone_country_id`='3', `zone_code`='GHA', `zone_name`='Ghardaia'  WHERE (`zone_id` = 88) ;
UPDATE `zones` SET `zone_id`='87', `zone_country_id`='3', `zone_code`='ETA', `zone_name`='El Tarf'  WHERE (`zone_id` = 87) ;
UPDATE `zones` SET `zone_id`='86', `zone_country_id`='3', `zone_code`='EOU', `zone_name`='El Oued'  WHERE (`zone_id` = 86) ;
UPDATE `zones` SET `zone_id`='85', `zone_country_id`='3', `zone_code`='EBA', `zone_name`='El Bayadh'  WHERE (`zone_id` = 85) ;
UPDATE `zones` SET `zone_id`='84', `zone_country_id`='3', `zone_code`='DJE', `zone_name`='Djelfa'  WHERE (`zone_id` = 84) ;
UPDATE `zones` SET `zone_id`='83', `zone_country_id`='3', `zone_code`='CON', `zone_name`='Constantine'  WHERE (`zone_id` = 83) ;
UPDATE `zones` SET `zone_id`='82', `zone_country_id`='3', `zone_code`='CHL', `zone_name`='Chlef'  WHERE (`zone_id` = 82) ;
UPDATE `zones` SET `zone_id`='81', `zone_country_id`='3', `zone_code`='BMD', `zone_name`='Boumerdes'  WHERE (`zone_id` = 81) ;
UPDATE `zones` SET `zone_id`='80', `zone_country_id`='3', `zone_code`='BOA', `zone_name`='Bouira'  WHERE (`zone_id` = 80) ;
UPDATE `zones` SET `zone_id`='79', `zone_country_id`='3', `zone_code`='BBA', `zone_name`='Bordj Bou Arreridj'  WHERE (`zone_id` = 79) ;
UPDATE `zones` SET `zone_id`='78', `zone_country_id`='3', `zone_code`='BLI', `zone_name`='Blida'  WHERE (`zone_id` = 78) ;
UPDATE `zones` SET `zone_id`='77', `zone_country_id`='3', `zone_code`='BIS', `zone_name`='Biskra'  WHERE (`zone_id` = 77) ;
UPDATE `zones` SET `zone_id`='76', `zone_country_id`='3', `zone_code`='BEJ', `zone_name`='Bejaia'  WHERE (`zone_id` = 76) ;
UPDATE `zones` SET `zone_id`='75', `zone_country_id`='3', `zone_code`='BEC', `zone_name`='Bechar'  WHERE (`zone_id` = 75) ;
UPDATE `zones` SET `zone_id`='74', `zone_country_id`='3', `zone_code`='BAT', `zone_name`='Batna'  WHERE (`zone_id` = 74) ;
UPDATE `zones` SET `zone_id`='73', `zone_country_id`='3', `zone_code`='ANN', `zone_name`='Annaba'  WHERE (`zone_id` = 73) ;
UPDATE `zones` SET `zone_id`='72', `zone_country_id`='3', `zone_code`='ALG', `zone_name`='Alger'  WHERE (`zone_id` = 72) ;
UPDATE `zones` SET `zone_id`='71', `zone_country_id`='3', `zone_code`='ATE', `zone_name`='Ain Temouchent'  WHERE (`zone_id` = 71) ;
UPDATE `zones` SET `zone_id`='70', `zone_country_id`='3', `zone_code`='ADE', `zone_name`='Ain Defla'  WHERE (`zone_id` = 70) ;
UPDATE `zones` SET `zone_id`='69', `zone_country_id`='3', `zone_code`='ADR', `zone_name`='Adrar'  WHERE (`zone_id` = 69) ;
UPDATE `zones` SET `zone_id`='68', `zone_country_id`='2', `zone_code`='VL', `zone_name`='Vlore'  WHERE (`zone_id` = 68) ;
UPDATE `zones` SET `zone_id`='67', `zone_country_id`='2', `zone_code`='TR', `zone_name`='Tirane'  WHERE (`zone_id` = 67) ;
UPDATE `zones` SET `zone_id`='66', `zone_country_id`='2', `zone_code`='TP', `zone_name`='Tropoje'  WHERE (`zone_id` = 66) ;
UPDATE `zones` SET `zone_id`='65', `zone_country_id`='2', `zone_code`='TE', `zone_name`='Tepelene'  WHERE (`zone_id` = 65) ;
UPDATE `zones` SET `zone_id`='64', `zone_country_id`='2', `zone_code`='SR', `zone_name`='Sarande'  WHERE (`zone_id` = 64) ;
UPDATE `zones` SET `zone_id`='63', `zone_country_id`='2', `zone_code`='SK', `zone_name`='Skrapar'  WHERE (`zone_id` = 63) ;
UPDATE `zones` SET `zone_id`='62', `zone_country_id`='2', `zone_code`='SH', `zone_name`='Shkoder'  WHERE (`zone_id` = 62) ;
UPDATE `zones` SET `zone_id`='61', `zone_country_id`='2', `zone_code`='PU', `zone_name`='Puke'  WHERE (`zone_id` = 61) ;
UPDATE `zones` SET `zone_id`='60', `zone_country_id`='2', `zone_code`='PG', `zone_name`='Pogradec'  WHERE (`zone_id` = 60) ;
UPDATE `zones` SET `zone_id`='59', `zone_country_id`='2', `zone_code`='PR', `zone_name`='Permet'  WHERE (`zone_id` = 59) ;
UPDATE `zones` SET `zone_id`='58', `zone_country_id`='2', `zone_code`='PQ', `zone_name`='Peqin'  WHERE (`zone_id` = 58) ;
UPDATE `zones` SET `zone_id`='57', `zone_country_id`='2', `zone_code`='MR', `zone_name`='Mirdite'  WHERE (`zone_id` = 57) ;
UPDATE `zones` SET `zone_id`='56', `zone_country_id`='2', `zone_code`='MT', `zone_name`='Mat'  WHERE (`zone_id` = 56) ;
UPDATE `zones` SET `zone_id`='55', `zone_country_id`='2', `zone_code`='MK', `zone_name`='Mallakaster'  WHERE (`zone_id` = 55) ;
UPDATE `zones` SET `zone_id`='54', `zone_country_id`='2', `zone_code`='MM', `zone_name`='Malesi e Madhe'  WHERE (`zone_id` = 54) ;
UPDATE `zones` SET `zone_id`='53', `zone_country_id`='2', `zone_code`='LU', `zone_name`='Lushnje'  WHERE (`zone_id` = 53) ;
UPDATE `zones` SET `zone_id`='52', `zone_country_id`='2', `zone_code`='LE', `zone_name`='Lezhe'  WHERE (`zone_id` = 52) ;
UPDATE `zones` SET `zone_id`='51', `zone_country_id`='2', `zone_code`='LB', `zone_name`='Librazhd'  WHERE (`zone_id` = 51) ;
UPDATE `zones` SET `zone_id`='50', `zone_country_id`='2', `zone_code`='KU', `zone_name`='Kukes'  WHERE (`zone_id` = 50) ;
UPDATE `zones` SET `zone_id`='49', `zone_country_id`='2', `zone_code`='KR', `zone_name`='Kruje'  WHERE (`zone_id` = 49) ;
UPDATE `zones` SET `zone_id`='48', `zone_country_id`='2', `zone_code`='KO', `zone_name`='Korce'  WHERE (`zone_id` = 48) ;
UPDATE `zones` SET `zone_id`='47', `zone_country_id`='2', `zone_code`='KC', `zone_name`='Kucove'  WHERE (`zone_id` = 47) ;
UPDATE `zones` SET `zone_id`='46', `zone_country_id`='2', `zone_code`='KB', `zone_name`='Kurbin'  WHERE (`zone_id` = 46) ;
UPDATE `zones` SET `zone_id`='45', `zone_country_id`='2', `zone_code`='KA', `zone_name`='Kavaje'  WHERE (`zone_id` = 45) ;
UPDATE `zones` SET `zone_id`='44', `zone_country_id`='2', `zone_code`='HA', `zone_name`='Has'  WHERE (`zone_id` = 44) ;
UPDATE `zones` SET `zone_id`='43', `zone_country_id`='2', `zone_code`='GR', `zone_name`='Gramsh'  WHERE (`zone_id` = 43) ;
UPDATE `zones` SET `zone_id`='42', `zone_country_id`='2', `zone_code`='GJ', `zone_name`='Gjirokaster'  WHERE (`zone_id` = 42) ;
UPDATE `zones` SET `zone_id`='41', `zone_country_id`='2', `zone_code`='FR', `zone_name`='Fier'  WHERE (`zone_id` = 41) ;
UPDATE `zones` SET `zone_id`='40', `zone_country_id`='2', `zone_code`='ER', `zone_name`='Kolonje'  WHERE (`zone_id` = 40) ;
UPDATE `zones` SET `zone_id`='39', `zone_country_id`='2', `zone_code`='EL', `zone_name`='Elbasan'  WHERE (`zone_id` = 39) ;
UPDATE `zones` SET `zone_id`='38', `zone_country_id`='2', `zone_code`='DR', `zone_name`='Durres'  WHERE (`zone_id` = 38) ;
UPDATE `zones` SET `zone_id`='37', `zone_country_id`='2', `zone_code`='DI', `zone_name`='Diber'  WHERE (`zone_id` = 37) ;
UPDATE `zones` SET `zone_id`='36', `zone_country_id`='2', `zone_code`='DV', `zone_name`='Devoll'  WHERE (`zone_id` = 36) ;
UPDATE `zones` SET `zone_id`='35', `zone_country_id`='2', `zone_code`='DL', `zone_name`='Delvine'  WHERE (`zone_id` = 35) ;
UPDATE `zones` SET `zone_id`='34', `zone_country_id`='2', `zone_code`='BU', `zone_name`='Bulqize'  WHERE (`zone_id` = 34) ;
UPDATE `zones` SET `zone_id`='33', `zone_country_id`='2', `zone_code`='BR', `zone_name`='Berat'  WHERE (`zone_id` = 33) ;
UPDATE `zones` SET `zone_id`='32', `zone_country_id`='1', `zone_code`='ZAB', `zone_name`='Zabol'  WHERE (`zone_id` = 32) ;
UPDATE `zones` SET `zone_id`='31', `zone_country_id`='1', `zone_code`='WAR', `zone_name`='Wardak'  WHERE (`zone_id` = 31) ;
UPDATE `zones` SET `zone_id`='30', `zone_country_id`='1', `zone_code`='TAK', `zone_name`='Takhar'  WHERE (`zone_id` = 30) ;
UPDATE `zones` SET `zone_id`='29', `zone_country_id`='1', `zone_code`='SAR', `zone_name`='Sar-e Pol'  WHERE (`zone_id` = 29) ;
UPDATE `zones` SET `zone_id`='28', `zone_country_id`='1', `zone_code`='SAM', `zone_name`='Samangan'  WHERE (`zone_id` = 28) ;
UPDATE `zones` SET `zone_id`='27', `zone_country_id`='1', `zone_code`='PAR', `zone_name`='Parwan'  WHERE (`zone_id` = 27) ;
UPDATE `zones` SET `zone_id`='26', `zone_country_id`='1', `zone_code`='PKA', `zone_name`='Paktika'  WHERE (`zone_id` = 26) ;
UPDATE `zones` SET `zone_id`='25', `zone_country_id`='1', `zone_code`='PIA', `zone_name`='Paktia'  WHERE (`zone_id` = 25) ;
UPDATE `zones` SET `zone_id`='24', `zone_country_id`='1', `zone_code`='ORU', `zone_name`='Oruzgan'  WHERE (`zone_id` = 24) ;
UPDATE `zones` SET `zone_id`='23', `zone_country_id`='1', `zone_code`='NUR', `zone_name`='Nurestan'  WHERE (`zone_id` = 23) ;
UPDATE `zones` SET `zone_id`='22', `zone_country_id`='1', `zone_code`='NIM', `zone_name`='Nimruz'  WHERE (`zone_id` = 22) ;
UPDATE `zones` SET `zone_id`='21', `zone_country_id`='1', `zone_code`='NAN', `zone_name`='Nangrahar'  WHERE (`zone_id` = 21) ;
UPDATE `zones` SET `zone_id`='20', `zone_country_id`='1', `zone_code`='LOW', `zone_name`='Lowgar'  WHERE (`zone_id` = 20) ;
UPDATE `zones` SET `zone_id`='19', `zone_country_id`='1', `zone_code`='LAG', `zone_name`='Laghman'  WHERE (`zone_id` = 19) ;
UPDATE `zones` SET `zone_id`='18', `zone_country_id`='1', `zone_code`='KDZ', `zone_name`='Kondoz'  WHERE (`zone_id` = 18) ;
UPDATE `zones` SET `zone_id`='17', `zone_country_id`='1', `zone_code`='KNR', `zone_name`='Konar'  WHERE (`zone_id` = 17) ;
UPDATE `zones` SET `zone_id`='16', `zone_country_id`='1', `zone_code`='KHO', `zone_name`='Khost'  WHERE (`zone_id` = 16) ;
UPDATE `zones` SET `zone_id`='15', `zone_country_id`='1', `zone_code`='KAP', `zone_name`='Kapisa'  WHERE (`zone_id` = 15) ;
UPDATE `zones` SET `zone_id`='14', `zone_country_id`='1', `zone_code`='KAN', `zone_name`='Kandahar'  WHERE (`zone_id` = 14) ;
UPDATE `zones` SET `zone_id`='13', `zone_country_id`='1', `zone_code`='KAB', `zone_name`='Kabul'  WHERE (`zone_id` = 13) ;
UPDATE `zones` SET `zone_id`='12', `zone_country_id`='1', `zone_code`='JOW', `zone_name`='Jowzjan'  WHERE (`zone_id` = 12) ;
UPDATE `zones` SET `zone_id`='11', `zone_country_id`='1', `zone_code`='HER', `zone_name`='Herat'  WHERE (`zone_id` = 11) ;
UPDATE `zones` SET `zone_id`='10', `zone_country_id`='1', `zone_code`='HEL', `zone_name`='Helmand'  WHERE (`zone_id` = 10) ;
UPDATE `zones` SET `zone_id`='9', `zone_country_id`='1', `zone_code`='GHO', `zone_name`='Ghowr'  WHERE (`zone_id` = 9) ;
UPDATE `zones` SET `zone_id`='8', `zone_country_id`='1', `zone_code`='GHA', `zone_name`='Ghazni'  WHERE (`zone_id` = 8) ;
UPDATE `zones` SET `zone_id`='7', `zone_country_id`='1', `zone_code`='FYB', `zone_name`='Faryab'  WHERE (`zone_id` = 7) ;
UPDATE `zones` SET `zone_id`='6', `zone_country_id`='1', `zone_code`='FRA', `zone_name`='Farah'  WHERE (`zone_id` = 6) ;
UPDATE `zones` SET `zone_id`='5', `zone_country_id`='1', `zone_code`='BAM', `zone_name`='Bamian'  WHERE (`zone_id` = 5) ;
UPDATE `zones` SET `zone_id`='4', `zone_country_id`='1', `zone_code`='BAL', `zone_name`='Balkh'  WHERE (`zone_id` = 4) ;
UPDATE `zones` SET `zone_id`='3', `zone_country_id`='1', `zone_code`='BGL', `zone_name`='Baghlan'  WHERE (`zone_id` = 3) ;
UPDATE `zones` SET `zone_id`='2', `zone_country_id`='1', `zone_code`='BDG', `zone_name`='Badghis'  WHERE (`zone_id` = 2) ;
UPDATE `zones` SET `zone_id`='1', `zone_country_id`='1', `zone_code`='BDS', `zone_name`='Badakhshan'  WHERE (`zone_id` = 1) ;
...
INSERT INTO `zones` VALUES ('4035', '222', 'Midlothian', 'Midlothian');
INSERT INTO `zones` VALUES ('4036', '222', 'Monmouthshire', 'Monmouthshire');
INSERT INTO `zones` VALUES ('4037', '222', 'Moray', 'Moray');
INSERT INTO `zones` VALUES ('4038', '222', 'Neath Port Talbot', 'Neath Port Talbot');
INSERT INTO `zones` VALUES ('4039', '222', 'Newport', 'Newport');
INSERT INTO `zones` VALUES ('4040', '222', 'Norfolk', 'Norfolk');
INSERT INTO `zones` VALUES ('4041', '222', 'North Ayrshire', 'North Ayrshire');
INSERT INTO `zones` VALUES ('4042', '222', 'North Lanarkshire', 'North Lanarkshire');
INSERT INTO `zones` VALUES ('4043', '222', 'North Yorkshire', 'North Yorkshire');
INSERT INTO `zones` VALUES ('4044', '222', 'Northamptonshire', 'Northamptonshire');
INSERT INTO `zones` VALUES ('4045', '222', 'Northumberland', 'Northumberland');
INSERT INTO `zones` VALUES ('4046', '222', 'Nottinghamshire', 'Nottinghamshire');
INSERT INTO `zones` VALUES ('4047', '222', 'Orkney Islands', 'Orkney Islands');
INSERT INTO `zones` VALUES ('4048', '222', 'Oxfordshire', 'Oxfordshire');
INSERT INTO `zones` VALUES ('4049', '222', 'Pembrokeshire', 'Pembrokeshire');
INSERT INTO `zones` VALUES ('4050', '222', 'Perth and Kinross', 'Perth and Kinross');
INSERT INTO `zones` VALUES ('4051', '222', 'Powys', 'Powys');
INSERT INTO `zones` VALUES ('4052', '222', 'Renfrewshire', 'Renfrewshire');
INSERT INTO `zones` VALUES ('4053', '222', 'Rhondda Cynon Taff', 'Rhondda Cynon Taff');
INSERT INTO `zones` VALUES ('4054', '222', 'Rutland', 'Rutland');
INSERT INTO `zones` VALUES ('4055', '222', 'Scottish Borders', 'Scottish Borders');
INSERT INTO `zones` VALUES ('4056', '222', 'Shetland Islands', 'Shetland Islands');
INSERT INTO `zones` VALUES ('4057', '222', 'Shropshire', 'Shropshire');
INSERT INTO `zones` VALUES ('4058', '222', 'Somerset', 'Somerset');
INSERT INTO `zones` VALUES ('4059', '222', 'South Ayrshire', 'South Ayrshire');
INSERT INTO `zones` VALUES ('4060', '222', 'South Lanarkshire', 'South Lanarkshire');
INSERT INTO `zones` VALUES ('4061', '222', 'South Yorkshire', 'South Yorkshire');
INSERT INTO `zones` VALUES ('4062', '222', 'Staffordshire', 'Staffordshire');
INSERT INTO `zones` VALUES ('4063', '222', 'Stirling', 'Stirling');
INSERT INTO `zones` VALUES ('4064', '222', 'Suffolk', 'Suffolk');
INSERT INTO `zones` VALUES ('4065', '222', 'Surrey', 'Surrey');
INSERT INTO `zones` VALUES ('4066', '222', 'Swansea', 'Swansea');
INSERT INTO `zones` VALUES ('4067', '222', 'Torfaen', 'Torfaen');
INSERT INTO `zones` VALUES ('4068', '222', 'Tyne and Wear', 'Tyne and Wear');
INSERT INTO `zones` VALUES ('4069', '222', 'Vale of Glamorgan', 'Vale of Glamorgan');
INSERT INTO `zones` VALUES ('4070', '222', 'Warwickshire', 'Warwickshire');
INSERT INTO `zones` VALUES ('4071', '222', 'West Dunbartonshire', 'West Dunbartonshire');
INSERT INTO `zones` VALUES ('4072', '222', 'West Lothian', 'West Lothian');
INSERT INTO `zones` VALUES ('4073', '222', 'West Midlands', 'West Midlands');
INSERT INTO `zones` VALUES ('4074', '222', 'West Sussex', 'West Sussex');
INSERT INTO `zones` VALUES ('4075', '222', 'West Yorkshire', 'West Yorkshire');
INSERT INTO `zones` VALUES ('4076', '222', 'Western Isles', 'Western Isles');
INSERT INTO `zones` VALUES ('4077', '222', 'Wiltshire', 'Wiltshire');
INSERT INTO `zones` VALUES ('4078', '222', 'Worcestershire', 'Worcestershire');
INSERT INTO `zones` VALUES ('4079', '222', 'Wrexham', 'Wrexham');
INSERT INTO `zones` VALUES ('4080', '223', 'AL', 'Alabama');
INSERT INTO `zones` VALUES ('4081', '223', 'AK', 'Alaska');
INSERT INTO `zones` VALUES ('4082', '223', 'AS', 'American Samoa');
INSERT INTO `zones` VALUES ('4083', '223', 'AZ', 'Arizona');
INSERT INTO `zones` VALUES ('4084', '223', 'AR', 'Arkansas');
INSERT INTO `zones` VALUES ('4085', '223', 'AF', 'Armed Forces Africa');
INSERT INTO `zones` VALUES ('4086', '223', 'AA', 'Armed Forces Americas');
INSERT INTO `zones` VALUES ('4087', '223', 'AC', 'Armed Forces Canada');
INSERT INTO `zones` VALUES ('4088', '223', 'AE', 'Armed Forces Europe');
INSERT INTO `zones` VALUES ('4089', '223', 'AM', 'Armed Forces Middle East');
INSERT INTO `zones` VALUES ('4090', '223', 'AP', 'Armed Forces Pacific');
INSERT INTO `zones` VALUES ('4091', '223', 'CA', 'California');
INSERT INTO `zones` VALUES ('4092', '223', 'CO', 'Colorado');
INSERT INTO `zones` VALUES ('4093', '223', 'CT', 'Connecticut');
INSERT INTO `zones` VALUES ('4094', '223', 'DE', 'Delaware');
INSERT INTO `zones` VALUES ('4095', '223', 'DC', 'District of Columbia');
INSERT INTO `zones` VALUES ('4096', '223', 'FM', 'Federated States Of Micronesia');
INSERT INTO `zones` VALUES ('4097', '223', 'FL', 'Florida');
INSERT INTO `zones` VALUES ('4098', '223', 'GA', 'Georgia');
INSERT INTO `zones` VALUES ('4099', '223', 'GU', 'Guam');
INSERT INTO `zones` VALUES ('4100', '223', 'HI', 'Hawaii');
INSERT INTO `zones` VALUES ('4101', '223', 'ID', 'Idaho');
INSERT INTO `zones` VALUES ('4102', '223', 'IL', 'Illinois');
INSERT INTO `zones` VALUES ('4103', '223', 'IN', 'Indiana');
INSERT INTO `zones` VALUES ('4104', '223', 'IA', 'Iowa');
INSERT INTO `zones` VALUES ('4105', '223', 'KS', 'Kansas');
INSERT INTO `zones` VALUES ('4106', '223', 'KY', 'Kentucky');
INSERT INTO `zones` VALUES ('4107', '223', 'LA', 'Louisiana');
INSERT INTO `zones` VALUES ('4108', '223', 'ME', 'Maine');
INSERT INTO `zones` VALUES ('4109', '223', 'MH', 'Marshall Islands');
INSERT INTO `zones` VALUES ('4110', '223', 'MD', 'Maryland');
INSERT INTO `zones` VALUES ('4111', '223', 'MA', 'Massachusetts');
INSERT INTO `zones` VALUES ('4112', '223', 'MI', 'Michigan');
INSERT INTO `zones` VALUES ('4113', '223', 'MN', 'Minnesota');
INSERT INTO `zones` VALUES ('4114', '223', 'MS', 'Mississippi');
INSERT INTO `zones` VALUES ('4115', '223', 'MO', 'Missouri');
INSERT INTO `zones` VALUES ('4116', '223', 'MT', 'Montana');
INSERT INTO `zones` VALUES ('4117', '223', 'NE', 'Nebraska');
INSERT INTO `zones` VALUES ('4118', '223', 'NV', 'Nevada');
INSERT INTO `zones` VALUES ('4119', '223', 'NH', 'New Hampshire');
INSERT INTO `zones` VALUES ('4120', '223', 'NJ', 'New Jersey');
INSERT INTO `zones` VALUES ('4121', '223', 'NM', 'New Mexico');
INSERT INTO `zones` VALUES ('4122', '223', 'NY', 'New York');
INSERT INTO `zones` VALUES ('4123', '223', 'NC', 'North Carolina');
INSERT INTO `zones` VALUES ('4124', '223', 'ND', 'North Dakota');
INSERT INTO `zones` VALUES ('4125', '223', 'MP', 'Northern Mariana Islands');
INSERT INTO `zones` VALUES ('4126', '223', 'OH', 'Ohio');
INSERT INTO `zones` VALUES ('4127', '223', 'OK', 'Oklahoma');
INSERT INTO `zones` VALUES ('4128', '223', 'OR', 'Oregon');
INSERT INTO `zones` VALUES ('4129', '223', 'PW', 'Palau');
INSERT INTO `zones` VALUES ('4130', '223', 'PA', 'Pennsylvania');
INSERT INTO `zones` VALUES ('4131', '223', 'PR', 'Puerto Rico');
INSERT INTO `zones` VALUES ('4132', '223', 'RI', 'Rhode Island');
INSERT INTO `zones` VALUES ('4133', '223', 'SC', 'South Carolina');
INSERT INTO `zones` VALUES ('4134', '223', 'SD', 'South Dakota');
INSERT INTO `zones` VALUES ('4135', '223', 'TN', 'Tennessee');
INSERT INTO `zones` VALUES ('4136', '223', 'TX', 'Texas');
INSERT INTO `zones` VALUES ('4137', '223', 'UT', 'Utah');
INSERT INTO `zones` VALUES ('4138', '223', 'VT', 'Vermont');
INSERT INTO `zones` VALUES ('4139', '223', 'VI', 'Virgin Islands');
INSERT INTO `zones` VALUES ('4140', '223', 'VA', 'Virginia');
INSERT INTO `zones` VALUES ('4141', '223', 'WA', 'Washington');
INSERT INTO `zones` VALUES ('4142', '223', 'WV', 'West Virginia');
INSERT INTO `zones` VALUES ('4143', '223', 'WI', 'Wisconsin');
INSERT INTO `zones` VALUES ('4144', '223', 'WY', 'Wyoming');
INSERT INTO `zones` VALUES ('4145', '224', 'BI', 'Baker Island');
INSERT INTO `zones` VALUES ('4146', '224', 'HI', 'Howland Island');
INSERT INTO `zones` VALUES ('4147', '224', 'JI', 'Jarvis Island');
INSERT INTO `zones` VALUES ('4148', '224', 'JA', 'Johnston Atoll');
INSERT INTO `zones` VALUES ('4149', '224', 'KR', 'Kingman Reef');
INSERT INTO `zones` VALUES ('4150', '224', 'MA', 'Midway Atoll');
INSERT INTO `zones` VALUES ('4151', '224', 'NI', 'Navassa Island');
INSERT INTO `zones` VALUES ('4152', '224', 'PA', 'Palmyra Atoll');
INSERT INTO `zones` VALUES ('4153', '224', 'WI', 'Wake Island');
INSERT INTO `zones` VALUES ('4154', '225', 'AR', 'Artigas');
INSERT INTO `zones` VALUES ('4155', '225', 'CA', 'Canelones');
INSERT INTO `zones` VALUES ('4156', '225', 'CL', 'Cerro Largo');
INSERT INTO `zones` VALUES ('4157', '225', 'CO', 'Colonia');
INSERT INTO `zones` VALUES ('4158', '225', 'DU', 'Durazno');
INSERT INTO `zones` VALUES ('4159', '225', 'FS', 'Flores');
INSERT INTO `zones` VALUES ('4160', '225', 'FA', 'Florida');
INSERT INTO `zones` VALUES ('4161', '225', 'LA', 'Lavalleja');
INSERT INTO `zones` VALUES ('4162', '225', 'MA', 'Maldonado');
INSERT INTO `zones` VALUES ('4163', '225', 'MO', 'Montevideo');
INSERT INTO `zones` VALUES ('4164', '225', 'PA', 'Paysandu');
INSERT INTO `zones` VALUES ('4165', '225', 'RN', 'Rio Negro');
INSERT INTO `zones` VALUES ('4166', '225', 'RV', 'Rivera');
INSERT INTO `zones` VALUES ('4167', '225', 'RO', 'Rocha');
INSERT INTO `zones` VALUES ('4168', '225', 'SL', 'Salto');
INSERT INTO `zones` VALUES ('4169', '225', 'SJ', 'San Jose');
INSERT INTO `zones` VALUES ('4170', '225', 'SO', 'Soriano');
INSERT INTO `zones` VALUES ('4171', '225', 'TA', 'Tacuarembo');
INSERT INTO `zones` VALUES ('4172', '225', 'TT', 'Treinta y Tres');
INSERT INTO `zones` VALUES ('4173', '226', 'AN', 'Andijon');
INSERT INTO `zones` VALUES ('4174', '226', 'BU', 'Buxoro');
INSERT INTO `zones` VALUES ('4175', '226', 'FA', 'Farg\'ona');
INSERT INTO `zones` VALUES ('4176', '226', 'JI', 'Jizzax');
INSERT INTO `zones` VALUES ('4177', '226', 'NG', 'Namangan');
INSERT INTO `zones` VALUES ('4178', '226', 'NW', 'Navoiy');
INSERT INTO `zones` VALUES ('4179', '226', 'QA', 'Qashqadaryo');
INSERT INTO `zones` VALUES ('4180', '226', 'QR', 'Qoraqalpog\'iston Republikasi');
INSERT INTO `zones` VALUES ('4181', '226', 'SA', 'Samarqand');
INSERT INTO `zones` VALUES ('4182', '226', 'SI', 'Sirdaryo');
INSERT INTO `zones` VALUES ('4183', '226', 'SU', 'Surxondaryo');
INSERT INTO `zones` VALUES ('4184', '226', 'TK', 'Toshkent City');
INSERT INTO `zones` VALUES ('4185', '226', 'TO', 'Toshkent Region');
INSERT INTO `zones` VALUES ('4186', '226', 'XO', 'Xorazm');
INSERT INTO `zones` VALUES ('4187', '227', 'MA', 'Malampa');
INSERT INTO `zones` VALUES ('4188', '227', 'PE', 'Penama');
INSERT INTO `zones` VALUES ('4189', '227', 'SA', 'Sanma');
INSERT INTO `zones` VALUES ('4190', '227', 'SH', 'Shefa');
INSERT INTO `zones` VALUES ('4191', '227', 'TA', 'Tafea');
INSERT INTO `zones` VALUES ('4192', '227', 'TO', 'Torba');
INSERT INTO `zones` VALUES ('4193', '229', 'AM', 'Amazonas');
INSERT INTO `zones` VALUES ('4194', '229', 'AN', 'Anzoategui');
INSERT INTO `zones` VALUES ('4195', '229', 'AP', 'Apure');
INSERT INTO `zones` VALUES ('4196', '229', 'AR', 'Aragua');
INSERT INTO `zones` VALUES ('4197', '229', 'BA', 'Barinas');
INSERT INTO `zones` VALUES ('4198', '229', 'BO', 'Bolivar');
INSERT INTO `zones` VALUES ('4199', '229', 'CA', 'Carabobo');
INSERT INTO `zones` VALUES ('4200', '229', 'CO', 'Cojedes');
INSERT INTO `zones` VALUES ('4201', '229', 'DA', 'Delta Amacuro');
INSERT INTO `zones` VALUES ('4202', '229', 'DF', 'Dependencias Federales');
INSERT INTO `zones` VALUES ('4203', '229', 'DI', 'Distrito Federal');
INSERT INTO `zones` VALUES ('4204', '229', 'FA', 'Falcon');
INSERT INTO `zones` VALUES ('4205', '229', 'GU', 'Guarico');
INSERT INTO `zones` VALUES ('4206', '229', 'LA', 'Lara');
INSERT INTO `zones` VALUES ('4207', '229', 'ME', 'Merida');
INSERT INTO `zones` VALUES ('4208', '229', 'MI', 'Miranda');
INSERT INTO `zones` VALUES ('4209', '229', 'MO', 'Monagas');
INSERT INTO `zones` VALUES ('4210', '229', 'NE', 'Nueva Esparta');
INSERT INTO `zones` VALUES ('4211', '229', 'PO', 'Portuguesa');
INSERT INTO `zones` VALUES ('4212', '229', 'SU', 'Sucre');
INSERT INTO `zones` VALUES ('4213', '229', 'TA', 'Tachira');
INSERT INTO `zones` VALUES ('4214', '229', 'TR', 'Trujillo');
INSERT INTO `zones` VALUES ('4215', '229', 'VA', 'Vargas');
INSERT INTO `zones` VALUES ('4216', '229', 'YA', 'Yaracuy');
INSERT INTO `zones` VALUES ('4217', '229', 'ZU', 'Zulia');
INSERT INTO `zones` VALUES ('4218', '230', 'AG', 'An Giang');
INSERT INTO `zones` VALUES ('4219', '230', 'BG', 'Bac Giang');
INSERT INTO `zones` VALUES ('4220', '230', 'BK', 'Bac Kan');
INSERT INTO `zones` VALUES ('4221', '230', 'BL', 'Bac Lieu');
INSERT INTO `zones` VALUES ('4222', '230', 'BC', 'Bac Ninh');
INSERT INTO `zones` VALUES ('4223', '230', 'BR', 'Ba Ria-Vung Tau');
INSERT INTO `zones` VALUES ('4224', '230', 'BN', 'Ben Tre');
INSERT INTO `zones` VALUES ('4225', '230', 'BH', 'Binh Dinh');
INSERT INTO `zones` VALUES ('4226', '230', 'BU', 'Binh Duong');
INSERT INTO `zones` VALUES ('4227', '230', 'BP', 'Binh Phuoc');
INSERT INTO `zones` VALUES ('4228', '230', 'BT', 'Binh Thuan');
INSERT INTO `zones` VALUES ('4229', '230', 'CM', 'Ca Mau');
INSERT INTO `zones` VALUES ('4230', '230', 'CT', 'Can Tho');
INSERT INTO `zones` VALUES ('4231', '230', 'CB', 'Cao Bang');
INSERT INTO `zones` VALUES ('4232', '230', 'DL', 'Dak Lak');
INSERT INTO `zones` VALUES ('4233', '230', 'DG', 'Dak Nong');
INSERT INTO `zones` VALUES ('4234', '230', 'DN', 'Da Nang');
INSERT INTO `zones` VALUES ('4235', '230', 'DB', 'Dien Bien');
INSERT INTO `zones` VALUES ('4236', '230', 'DI', 'Dong Nai');
INSERT INTO `zones` VALUES ('4237', '230', 'DT', 'Dong Thap');
INSERT INTO `zones` VALUES ('4238', '230', 'GL', 'Gia Lai');
INSERT INTO `zones` VALUES ('4239', '230', 'HG', 'Ha Giang');
INSERT INTO `zones` VALUES ('4240', '230', 'HD', 'Hai Duong');
INSERT INTO `zones` VALUES ('4241', '230', 'HP', 'Hai Phong');
INSERT INTO `zones` VALUES ('4242', '230', 'HM', 'Ha Nam');
INSERT INTO `zones` VALUES ('4243', '230', 'HI', 'Ha Noi');
INSERT INTO `zones` VALUES ('4244', '230', 'HT', 'Ha Tay');
INSERT INTO `zones` VALUES ('4245', '230', 'HH', 'Ha Tinh');
INSERT INTO `zones` VALUES ('4246', '230', 'HB', 'Hoa Binh');
INSERT INTO `zones` VALUES ('4247', '230', 'HC', 'Ho Chin Minh');
INSERT INTO `zones` VALUES ('4248', '230', 'HU', 'Hau Giang');
INSERT INTO `zones` VALUES ('4249', '230', 'HY', 'Hung Yen');
INSERT INTO `zones` VALUES ('4250', '232', 'C', 'Saint Croix');
INSERT INTO `zones` VALUES ('4251', '232', 'J', 'Saint John');
INSERT INTO `zones` VALUES ('4252', '232', 'T', 'Saint Thomas');
INSERT INTO `zones` VALUES ('4253', '233', 'A', 'Alo');
INSERT INTO `zones` VALUES ('4254', '233', 'S', 'Sigave');
INSERT INTO `zones` VALUES ('4255', '233', 'W', 'Wallis');
INSERT INTO `zones` VALUES ('4256', '235', 'AB', 'Abyan');
INSERT INTO `zones` VALUES ('4257', '235', 'AD', 'Adan');
INSERT INTO `zones` VALUES ('4258', '235', 'AM', 'Amran');
INSERT INTO `zones` VALUES ('4259', '235', 'BA', 'Al Bayda');
INSERT INTO `zones` VALUES ('4260', '235', 'DA', 'Ad Dali');
INSERT INTO `zones` VALUES ('4261', '235', 'DH', 'Dhamar');
INSERT INTO `zones` VALUES ('4262', '235', 'HD', 'Hadramawt');
INSERT INTO `zones` VALUES ('4263', '235', 'HJ', 'Hajjah');
INSERT INTO `zones` VALUES ('4264', '235', 'HU', 'Al Hudaydah');
INSERT INTO `zones` VALUES ('4265', '235', 'IB', 'Ibb');
INSERT INTO `zones` VALUES ('4266', '235', 'JA', 'Al Jawf');
INSERT INTO `zones` VALUES ('4267', '235', 'LA', 'Lahij');
INSERT INTO `zones` VALUES ('4268', '235', 'MA', 'Ma\'rib');
INSERT INTO `zones` VALUES ('4269', '235', 'MR', 'Al Mahrah');
INSERT INTO `zones` VALUES ('4270', '235', 'MW', 'Al Mahwit');
INSERT INTO `zones` VALUES ('4271', '235', 'SD', 'Sa\'dah');
INSERT INTO `zones` VALUES ('4272', '235', 'SN', 'San\'a');
INSERT INTO `zones` VALUES ('4273', '235', 'SH', 'Shabwah');
INSERT INTO `zones` VALUES ('4274', '235', 'TA', 'Ta\'izz');
INSERT INTO `zones` VALUES ('4275', '236', 'KOS', 'Kosovo');
INSERT INTO `zones` VALUES ('4276', '236', 'MON', 'Montenegro');
INSERT INTO `zones` VALUES ('4277', '236', 'SER', 'Serbia');
INSERT INTO `zones` VALUES ('4278', '236', 'VOJ', 'Vojvodina');
INSERT INTO `zones` VALUES ('4279', '237', 'BC', 'Bas-Congo');
INSERT INTO `zones` VALUES ('4280', '237', 'BN', 'Bandundu');
INSERT INTO `zones` VALUES ('4281', '237', 'EQ', 'Equateur');
INSERT INTO `zones` VALUES ('4282', '237', 'KA', 'Katanga');
INSERT INTO `zones` VALUES ('4283', '237', 'KE', 'Kasai-Oriental');
INSERT INTO `zones` VALUES ('4284', '237', 'KN', 'Kinshasa');
INSERT INTO `zones` VALUES ('4285', '237', 'KW', 'Kasai-Occidental');
INSERT INTO `zones` VALUES ('4286', '237', 'MA', 'Maniema');
INSERT INTO `zones` VALUES ('4287', '237', 'NK', 'Nord-Kivu');
INSERT INTO `zones` VALUES ('4288', '237', 'OR', 'Orientale');
INSERT INTO `zones` VALUES ('4289', '237', 'SK', 'Sud-Kivu');
INSERT INTO `zones` VALUES ('4290', '238', 'CE', 'Central');
INSERT INTO `zones` VALUES ('4291', '238', 'CB', 'Copperbelt');
INSERT INTO `zones` VALUES ('4292', '238', 'EA', 'Eastern');
INSERT INTO `zones` VALUES ('4293', '238', 'LP', 'Luapula');
INSERT INTO `zones` VALUES ('4294', '238', 'LK', 'Lusaka');
INSERT INTO `zones` VALUES ('4295', '238', 'NO', 'Northern');
INSERT INTO `zones` VALUES ('4296', '238', 'NW', 'North-Western');
INSERT INTO `zones` VALUES ('4297', '238', 'SO', 'Southern');
INSERT INTO `zones` VALUES ('4298', '238', 'WE', 'Western');
INSERT INTO `zones` VALUES ('4299', '239', 'BU', 'Bulawayo');
INSERT INTO `zones` VALUES ('4300', '239', 'HA', 'Harare');
INSERT INTO `zones` VALUES ('4301', '239', 'ML', 'Manicaland');
INSERT INTO `zones` VALUES ('4302', '239', 'MC', 'Mashonaland Central');
INSERT INTO `zones` VALUES ('4303', '239', 'ME', 'Mashonaland East');
INSERT INTO `zones` VALUES ('4304', '239', 'MW', 'Mashonaland West');
INSERT INTO `zones` VALUES ('4305', '239', 'MV', 'Masvingo');
INSERT INTO `zones` VALUES ('4306', '239', 'MN', 'Matabeleland North');
INSERT INTO `zones` VALUES ('4307', '239', 'MS', 'Matabeleland South');
INSERT INTO `zones` VALUES ('4308', '239', 'MD', 'Midlands');
