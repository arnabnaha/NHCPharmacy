<?php
/*
$Id: article_reviews_write.php 1857 2012-06-20 01:21:38Z michael.oscmax@gmail.com $
...
// (Sub 'fallback' with your current template to see if there is a template specific file.)
  ...
  if (isset($_GET['action']) && ($_GET['action'] == 'process')) {
    ...
    if ($error == false) {
      ...
      tep_redirect(tep_href_link(FILENAME_ARTICLE_REVIEWS, tep_get_all_get_params(array('action')) . 'message=display'));
    }
  }

  $articles_name = $article_info['articles_name'];

  require(bts_select('language', FILENAME_ARTICLE_REVIEWS_WRITE));
