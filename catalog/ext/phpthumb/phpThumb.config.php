...
/* MF - Removed trailing / from DIR_FS_CATALOG/; */
...
$PHPTHUMB_CONFIG['cache_directory'] = $PHPTHUMB_CONFIG['document_root'].'/cache/';            // oscThumb: set the cache directory to an absolute directory for all source images
