...
define('ENTRY_AFFILIATE_AGB_ERROR', ' &nbsp;<small><span class="errorText">You must accept our Affiliate Program Terms & Conditions</span></small>');
define('ENTRY_AFFILIATE_PAYMENT_CHECK', 'Check Payee Name:');
define('ENTRY_AFFILIATE_PAYMENT_CHECK_TEXT', '');
define('ENTRY_AFFILIATE_PAYMENT_CHECK_ERROR', '&nbsp;<small><span class="errorText">required</span></small>');
define('ENTRY_AFFILIATE_PAYMENT_PAYPAL', 'PayPal Account Email:');
define('ENTRY_AFFILIATE_PAYMENT_PAYPAL_TEXT', '');
define('ENTRY_AFFILIATE_PAYMENT_PAYPAL_ERROR', '&nbsp;<small><span class="errorText">required</span></small>');
define('ENTRY_AFFILIATE_PAYMENT_BANK_NAME', 'Bank Name:');
define('ENTRY_AFFILIATE_PAYMENT_BANK_NAME_TEXT', '');
define('ENTRY_AFFILIATE_PAYMENT_BANK_NAME_ERROR', '&nbsp;<small><span class="errorText">required</span></small>');
define('ENTRY_AFFILIATE_PAYMENT_BANK_ACCOUNT_NAME', 'Account Name:');
define('ENTRY_AFFILIATE_PAYMENT_BANK_ACCOUNT_NAME_TEXT', '');
define('ENTRY_AFFILIATE_PAYMENT_BANK_ACCOUNT_NAME_ERROR', '&nbsp;<small><span class="errorText">required</span></small>');
define('ENTRY_AFFILIATE_PAYMENT_BANK_ACCOUNT_NUMBER', 'Account Number:');
define('ENTRY_AFFILIATE_PAYMENT_BANK_ACCOUNT_NUMBER_TEXT', '');
define('ENTRY_AFFILIATE_PAYMENT_BANK_ACCOUNT_NUMBER_ERROR', '&nbsp;<small><span class="errorText">required</span></small>');
...
define('ENTRY_AFFILIATE_PAYMENT_BANK_BRANCH_NUMBER_ERROR', '&nbsp;<small><span class="errorText">required</span></small>');
define('ENTRY_AFFILIATE_PAYMENT_BANK_SWIFT_CODE', 'SWIFT Code:');
define('ENTRY_AFFILIATE_PAYMENT_BANK_SWIFT_CODE_TEXT', '');
define('ENTRY_AFFILIATE_PAYMENT_BANK_SWIFT_CODE_ERROR', '&nbsp;<small><span class="errorText">required</span></small>');
define('ENTRY_AFFILIATE_COMPANY', 'Company');
define('ENTRY_AFFILIATE_COMPANY_TEXT', '');
define('ENTRY_AFFILIATE_COMPANY_ERROR', '&nbsp;<small><span class="errorText">required</span></small>');
define('ENTRY_AFFILIATE_COMPANY_TAXID', 'TAX ID.:');
define('ENTRY_AFFILIATE_COMPANY_TAXID_TEXT', '');
define('ENTRY_AFFILIATE_COMPANY_TAXID_ERROR', '&nbsp;<small><span class="errorText">required</span></small>');
define('ENTRY_AFFILIATE_HOMEPAGE', 'Homepage');
define('ENTRY_AFFILIATE_HOMEPAGE_TEXT', '&nbsp;required (http://)');
define('ENTRY_AFFILIATE_HOMEPAGE_ERROR', '&nbsp;<small><span class="errorText">required (http://)</span></small>');
define('ENTRY_AFFILIATE_NEWSLETTER', 'Affiliate Newsletter');
define('ENTRY_AFFILIATE_NEWSLETTER_TEXT','');
define('ENTRY_AFFILIATE_NEWSLETTER_ERROR', '&nbsp;<small><span class="errorText">required</span></small>');
