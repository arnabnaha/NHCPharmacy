...
define('NAVBAR_TITLE', 'Sales Report');
define('HEADING_TITLE', 'Affiliate Program: Sales');

define('TABLE_HEADING_DATE', 'Date');
define('TABLE_HEADING_SALES', 'Affiliate Earnings');
define('TABLE_HEADING_VALUE', 'Sale Value');
...
define('HEADING_SALE_VALUE_HELP', 'Sale Value Help');
...
define('HEADING_COMMISSION_VALUE_HELP', 'Affiliate Earnings Help');
define('TEXT_COMMISSION_VALUE_HELP', '<i>Affiliate Earnings</i> represents the commission due on the sale.');
define('HEADING_STATUS_HELP', 'Sale Status Help');
