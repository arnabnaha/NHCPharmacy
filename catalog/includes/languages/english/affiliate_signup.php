...
define('MAIL_AFFILIATE_SUBJECT', 'Welcome to %s Affiliate Program');
define('MAIL_GREET_NONE', 'Dear %s' . "\n\n");
define('MAIL_AFFILIATE_HEADER', 'Thank you for joining <b>%s</b> Affiliate Program' . "\n\n" .'Your Account Information:
**********************************************'."\n\n");
