<?php
/*
$Id: core.php 1959 2013-03-05 17:01:31Z michael.oscmax@gmail.com $
...
define('HEADER_TITLE_BASKET_CONTENTS', 'Basket');
...
define('MAILCHIMP_EXISTING_USER_UNSUBSCRIBED', 'You are currently <strong>not</strong> subscribed to our newsletter');
...
define('ICON_CLEAR_HISTORY', 'Clear History');
...
define('ERROR_TEP_MAIL', '<span class="errorText"><b><small>TEP ERROR:</small> Cannot send the email through the specified SMTP server. Please check your php.ini setting and correct the SMTP server if necessary.</b></span>');
