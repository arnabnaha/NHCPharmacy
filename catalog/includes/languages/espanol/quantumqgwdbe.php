<?php
/*
  $Id: quantumqgwdbe.php 1692 2012-02-26 01:26:50Z michael.oscmax@gmail.com $
...
*/
  ...
  define('MODULE_PAYMENT_QUANTUMQGWDBE_TEXT_PUBLIC_TITLE', 'Tarjeta de crédito');
  ...
  define('MODULE_PAYMENT_QUANTUMQGWDBE_TEXT_CREDIT_CARD_CVV', 'Código CVV de la tarjeta de crédito:');
  define('MODULE_PAYMENT_QUANTUMQGWDBE_TEXT_NOT_CVV', 'Active si no puede escribir el código CVV:');
  define('MODULE_PAYMENT_QUANTUMQGWDBE_TEXT_REASON_NOT_CVV', '¿Por qué no puede escribir el código CVV?:');
  ...
  define('MODULE_PAYMENT_QUANTUMQGWDBE_TEXT_MISSING_CC_NUMBER', 'Debe introducir un número de tarjeta de crédito.\n');
