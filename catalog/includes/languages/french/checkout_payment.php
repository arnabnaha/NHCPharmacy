<?php
/*
$Id: checkout_payment.php 1959 2013-03-05 17:01:31Z michael.oscmax@gmail.com $
...
define('MODULE_PAYMENT_PAYPALSTANDARD_IMAGE', '<img src="includes/languages/french/images/buttons/paypal.gif" border="0" alt="">');
define('MODULE_PAYMENT_PAYPALSTANDARD_TEXT', 'En utilisant PayPal comme moyen de paiement pour régler un achat, en France, Belqique, Luxembourg comme à l\’étranger, si vous ne recevez pas votre objet, PayPal vous rembourse le montant total de la transaction, frais de port inclus. En plus cette protection est gratuite.<br> 
<a href="https://cms.paypal.com/fr/cgi-bin/marketingweb?cmd=_render-content&content_ID=marketing_fr/particuliers_premiers_pas&nav=1.0" target="_blank"><u>Pour en savoir plus cliquez ici.</u></a>');
?>