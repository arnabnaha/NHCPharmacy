<?php
/*
$Id: login.php 1959 2013-03-05 17:01:31Z michael.oscmax@gmail.com $
...
define('PWA_FAIL_ACCOUNT_EXISTS', 'Un compte existe d&eacute;jà pour cette adresse e-mail <i>{EMAIL_ADDRESS}</i>.  Vous devez vous identifier avant de proc&eacute;der à la commande.');
...
define('PROCEED_TO_CHECKOUT', 'Proc&eacute;dez à la commande sans enregistrement.');
...
define('TEXT_GUEST_INTRODUCTION','<b>Voulez-vous d\'aller directement à la proc&eacute;dure de paiement?</b> <br><br> Souhaitez-vous commander sans cr&eacute;er un compte client? S\'il vous plaît noter que l\'ensemble de nos services ne seront pas disponibles pour les clients qui ne souhaitent pas cr&eacute;er un compte. En outre, vous ne pouvez pas afficher l\'&eacute;tat de votre commande, et chaque fois que vous magasinez avec nous, vous devrez entrer de nouveau toutes vos donn&eacute;es. <br><br> Cr&eacute;ation d\'un compte est gratuite. Si vous souhaitez encore passer à la caisse s\'il vous plaît cliquer sur le bouton de "Continuer" sur votre droite.');

define('TEXT_GV_LOGIN_NEEDED', 'Vous devez être connect&eacute; pour &eacute;changer votre bon. S\'il vous plaît cr&eacute;er un nouveau compte ou se connecter ci-dessous');
