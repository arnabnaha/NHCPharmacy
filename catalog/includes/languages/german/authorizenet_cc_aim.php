...
*/
  ...
  define('MODULE_PAYMENT_AUTHORIZENET_CC_AIM_TEXT_DESCRIPTION', '<img src="images/icons/icon_popup.gif" border="0" alt="">&nbsp;<a href="https://www.authorize.net" target="_blank" style="text-decoration: underline; font-weight: bold;">Authorize.net Homepage besuchen</a>');
  ...
  define('MODULE_PAYMENT_AUTHORIZENET_CC_AIM_CREDIT_CARD_EXPIRES', 'Gültig bis:');
  ...
  define('MODULE_PAYMENT_AUTHORIZENET_CC_AIM_ERROR_GENERAL', 'Bitte versuchen Sie es erneut. Wenn das Problem weiterhin besteht, wählen Sie bitte eine andere Zahlungsweise.');
  define('MODULE_PAYMENT_AUTHORIZENET_CC_AIM_ERROR_DECLINED', 'Ihre Kreditkarte wurde abgelehnt. Bitte versuchen Sie es mit einer anderen Karte oder wählen Sie eine andere Zahlungsweise.');
  define('MODULE_PAYMENT_AUTHORIZENET_CC_AIM_ERROR_INVALID_EXP_DATE', 'Das Ablaufdatum der Kreditkarte ist falsch. Bitte überprüfen Sie die Kreditkarteninformationen.');
  ...
  define('MODULE_PAYMENT_AUTHORIZENET_CC_AIM_ERROR_CVC', 'Die Kreditkartenprüfnummer ist ungültig. Bitte überprüfen Sie die Kreditkarteninformationen und versuchen Sie es erneut.');
