...
*/
    ...
    class pm2checkout {
        ...
        function selection() {  // from Paypal_IPN
            $img_visa = DIR_WS_ICONS . 'visa.gif';
            $img_mc = DIR_WS_ICONS . 'mastercard.gif';
            $img_discover = DIR_WS_ICONS . 'discover.gif';
            $img_amex = DIR_WS_ICONS . 'amex.gif';
            $img_diners = DIR_WS_ICONS . 'diners.gif';
            $img_jcb = DIR_WS_ICONS . 'jcb.gif';
