<?php
/*
$Id: freeshipper.php 1959 2013-03-05 17:01:31Z michael.oscmax@gmail.com $
...
// class methods
    ...
    function install() {
      tep_db_query("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) values ('CT_MODULE_SHIPPING_STATUS', 'MODULE_SHIPPING_FREESHIPPER_STATUS', '1', 'CD_MODULE_SHIPPING_STATUS', '6', '5', now())");
      tep_db_query("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) values ('CT_MODULE_SHIPPING_COST', 'MODULE_SHIPPING_FREESHIPPER_COST', '0.00', 'CD_MODULE_SHIPPING_COST', '6', '6', now())");
      tep_db_query("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, use_function, set_function, date_added) values ('CT_MODULE_SHIPPING_TAX_CLASS', 'MODULE_SHIPPING_FREESHIPPER_TAX_CLASS', '0', 'CD_MODULE_SHIPPING_TAX_CLASS', '6', '0', 'tep_get_tax_class_title', 'tep_cfg_pull_down_tax_classes(', now())");
      tep_db_query("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, use_function, set_function, date_added) values ('CT_MODULE_SHIPPING_ZONE', 'MODULE_SHIPPING_FREESHIPPER_ZONE', '0', 'CD_MODULE_SHIPPING_ZONE', '6', '0', 'tep_get_zone_class_title', 'tep_cfg_pull_down_zone_classes(', now())");
      tep_db_query("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) values ('CT_MODULE_SHIPPING_SORT_ORDER', 'MODULE_SHIPPING_FREESHIPPER_SORT_ORDER', '0', 'CD_MODULE_SHIPPING_SORT_ORDER', '6', '0', now())");
    }
