<?php
/*
$Id: item.php 1959 2013-03-05 17:01:31Z michael.oscmax@gmail.com $
...
// class methods
    ...
    function install() {
      tep_db_query("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added) values ('CT_MODULE_SHIPPING_STATUS', 'MODULE_SHIPPING_ITEM_STATUS', 'True', 'CD_MODULE_SHIPPING_STATUS', '6', '0', 'tep_cfg_select_option(array(\'True\', \'False\'), ', now())");
      tep_db_query("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) values ('CT_MODULE_SHIPPING_COST', 'MODULE_SHIPPING_ITEM_COST', '2.50', 'CD_MODULE_SHIPPING_COST', '6', '0', now())");
      tep_db_query("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) values ('CT_MODULE_SHIPPING_HANDLING', 'MODULE_SHIPPING_ITEM_HANDLING', '0', 'CD_MODULE_SHIPPING_HANDLING', '6', '0', now())");
      ...
      tep_db_query("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) values ('CT_MODULE_SHIPPING_SORT_ORDER', 'MODULE_SHIPPING_ITEM_SORT_ORDER', '0', 'CD_MODULE_SHIPPING_SORT_ORDER', '6', '0', now())");
    }
