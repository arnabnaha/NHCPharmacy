<?php
/*
$Id: rmfirstrec.php 1692 2012-02-26 01:26:50Z michael.oscmax@gmail.com $
...
class rmfirstrec {
	...
	function rmfirstrec() {
		...
		$this->version = ((defined('MODULE_SHIPPING_RMFIRSTREC_VERSION')) ? MODULE_SHIPPING_RMFIRSTREC_VERSION : '?.?');
	...
	function install() {
		...
		tep_db_query("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) values ('Maximum value to ship', 'MODULE_SHIPPING_RMFIRSTREC_MAX_VALUE', '41', 'Enter the maximum value to ship in &pound;', '6', '0', now())");
		...
		for ($i = 1; $i <= $this->num_zones; $i++) {
			...
			if ($i == 1) {
				...
				$shipping_table = '.1:2.13,.25:2.46,.5:2.98,.75:3.49,1:4.09,1.25:5.24,1.5:5.94,1.75:6.64,2:7.34,4:8.96,6:11.76,8:14.56,10:17.36';
