<?php
/*
$Id: Usu_Information.php 978 2011-01-06 01:22:29Z michael.oscmax@gmail.com $
...
class Usu_Information extends aDataMap {
  ...
  const DEPENDENCY = 'info_id'; // _GET key like e.g. cPath or lPath etc.
  const FILENAME = 'information.php'; // The filename define of the file where this code will be actioned
  ...
  protected function acquire( $base_path, $full_path ) {
    ...
    */
    $this->information_title = $this->linkText( $row['information_title'] );
